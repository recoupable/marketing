  ...
  return <section className="sky-section sky-products" id="tools" aria-labelledby="sky-tools-title">
    ...
    <div className="sky-products-grid" data-reveal-group="">
      <article className="sky-product-platform">
        <div className="sky-product-copy"><p className="sky-product-kicker">01 / PLATFORM</p><h3>Your music team’s<br />AI workspace.</h3><p>{homeCopy.tools.platform}</p><div className="sky-product-platform-price"><strong>{planPrice("platform", "monthly").monthly}<span> / month</span></strong><span>Platform + music skill pack · USD</span></div><Link href="/platform" className="sky-product-action">Explore the platform<span><SkyArrow /></span></Link></div>
      ...
      <article className="sky-product-skills">
        ...
        <div className="sky-product-copy"><p className="sky-product-kicker">02 / OPEN-SOURCE SKILLS</p><h3>Give your agent<br />a music playbook.</h3><p>{homeCopy.tools.skills}</p><Link href="/skills" className="sky-product-text-link">Explore the Skills <SkyArrow direction="right" /></Link><small className="sky-product-cost-note">AI client and service usage costs may apply.</small></div>
      </article>
      <article className="sky-product-developers">
        ...
        <div className="sky-product-copy"><p className="sky-product-kicker">03 / API, MCP &amp; CLI</p><h3>Build Recoup<br />into your product.</h3><p>{homeCopy.tools.developers}</p><Link href="/developers" className="sky-product-text-link">Explore developer tools <SkyArrow direction="right" /></Link><small className="sky-product-cost-note">API and MCP usage billed separately.</small></div>
      </article>
    </div>
  </section>;
}
