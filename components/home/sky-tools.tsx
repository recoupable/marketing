...
export function SkySoftwareStrip() {
  return <section className="sky-section sky-products" id="tools" aria-labelledby="sky-tools-title">
    <header className="sky-products-heading" data-reveal=""><p className="sky-section-label">RECOUP TOOLS</p><h2 id="sky-tools-title">Use Recoup Cloud.<br /><span>Or bring your own&nbsp;AI.</span></h2><p>{homeCopy.tools.introduction}</p></header>
    <div className="sky-products-grid" data-reveal-group="">
      <article className="sky-product-platform">
        <div className="sky-product-copy"><p className="sky-product-kicker">{homeCopy.tools.platformLabel}</p><h3>Your music team’s<br />AI workspace.</h3><p>{homeCopy.tools.platform}</p><div className="sky-product-platform-price"><strong>{planPrice("platform", "monthly").monthly}<span> / month</span></strong><span>Recoup Cloud + music skill pack · USD</span></div><Link href="/platform" className="sky-product-action">Explore Recoup Cloud<span><SkyArrow /></span></Link></div>
