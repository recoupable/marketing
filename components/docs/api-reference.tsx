...
export async function ApiReference({page}:{page:DocPage}) {
 ...
 return <div className="docs-api-content">
  ...
  <section id="request-example"><h2>Request</h2><DocsCode language="bash" label="cURL">{request}</DocsCode>{parameters.some(param=>param.in==='query'||param.in==='path')&&<p className="docs-small-note">Replace the YOUR_ placeholders with your values. Required query parameters are included; optional parameters are listed below.</p>}</section>
