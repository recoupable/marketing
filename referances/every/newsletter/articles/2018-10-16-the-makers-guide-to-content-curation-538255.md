---
title: "The Maker’s Guide to Content Curation, Part 1: Open-Sourcing Your Learning Process"
author: "Tiago Forte"
date: 2018-10-16
column: forte-labs
url: https://every.to/forte-labs/the-makers-guide-to-content-curation-538255
paywalled: false
scraped_at: 2026-06-11T16:09:37.737Z
---
...
-
**Slideshows**: create a slide presentation of the best examples or models, and upload it to a site like [Slideshare](https://www.slideshare.net/)
...
- Create a PDF and sell it directly on your website using [Gumroad](https://gumroad.com/)

- Start a blog on [WordPress](https://wordpress.com/) and charge for some of the articles using [Memberful](https://memberful.com/) or [Patreon](https://www.patreon.com/)

- Publish your work for free and take donations using [Paypal](https://www.paypal.com/us/home)

- Publish a course on [Teachable](https://teachable.com/) or [Thinkific](https://www.thinkific.com/) and charge for access

- Create a profile on [Clarity](https://clarity.fm/) and charge by the minute for phone calls, using your content to market your expertise

- Create a paid email newsletter using [Revue](https://www.getrevue.co/) and distribute it via [Mailchimp](https://mailchimp.com/)

- Set up an online forum using [Discourse](https://www.discourse.org/) and charge for access
...
*Sources: this series borrows a lot of ideas and phrases from Austin Kleon’s *Show Your Work* ([affiliate link](https://amzn.to/2CgpJim)), Daniel Pink’s *To Sell is Human* ([affiliate link](https://amzn.to/2J3iFag)), and Brendon Burchard’s *The Millionaire Messenger* ([affiliate link](https://amzn.to/2pVX1fk)). In other words, this article curates and summarizes their work!*

### [READ PART 2](https://every.to/praxis/the-makers-guide-to-content-curation-273-538256)
