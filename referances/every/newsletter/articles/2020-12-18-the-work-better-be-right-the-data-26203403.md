---
title: "“The work better be right:” The data kingdom of Jeremy Singer-Vine
"
subtitle: "The National Magazine Award winner and Buzzfeed News data editor relies on transparency, generosity, and collaboration to hold power accountable
"
author: "Sherrell Dorsey, Annaliese Griffin"
date: 2020-12-18
column: free-radicals
url: https://every.to/free-radicals/the-work-better-be-right-the-data-26203403
paywalled: false
scraped_at: 2026-06-11T16:09:08.875Z
---
...
*Welcome to Free Radicals — a collaboration between [Everything](https://every.to/everything/) and [Sherrell Dorsey](https://twitter.com/Sherrell_Dorsey), founder of [The Plug](https://tpinsights.com/). Each edition features a conversation between Sherrell and someone who embodies leadership, focusing on equity, advancement, expansive thinking, and progress. This is the fourth edition, featuring Jeremy Singer-Vine. *

*To read previous editions, and sign up for future updates, [click here](https://docs.google.com/forms/d/e/1FAIpQLSczbj-NZY5AYGfqXepQ3sC9xby16-y9Rrp4tDVZTXEk53ghqw/viewform?usp=sf_link).*

*Enjoy.*

[![](http://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1450/optimized_e69e4995-c642-4a47-9eb7-3cc0ef81db28_2024x1012.png)](http://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1450/optimized_e69e4995-c642-4a47-9eb7-3cc0ef81db28_2024x1012.png)

Jeremy Singer-Vine is the data editor for the investigations team at Buzzfeed News. Their recent [FinCEN Files investigation](https://www.buzzfeednews.com/article/jsvine/fincen-files-explainer-data-money-transactions), done in collaboration with the [International Consortium of Investigative Journalists](https://www.icij.org/investigations/fincen-files/mining-sars-data/), illuminated the movement of more than $2 trillion in suspicious financial transactions around the globe, and resulted in the [most riveting podcast about paperwork](https://podcasts.apple.com/us/podcast/suspicious-activity-inside-the-fincen-files/id1531918384) to date.
...
Although he started out as a photographer, and then worked as a general assignment reporter in several newsrooms, Singer-Vine discovered data journalism and data visualization during an internship at Slate in 2009. He started learning computer programming languages in his spare time, to be able to do more with the information he was grappling with, and how he could present it to readers. In 2014, Singer-Vine and reporter John R. Emshwiller were named [Pulitzer Prize finalists for a Wall Street Journal series](https://www.pulitzer.org/finalists/john-emshwiller-and-jeremy-singer-vine) investigating largely-overlooked factories and labs that once helped to develop and produce nuclear weapons in the US, many of which had not been properly cleaned up.

Each edition of his weekly newsletter, [Data is Plural](https://tinyletter.com/data-is-plural), delivers a collection of data sets organized around five different topics. Some are connected to the news cycle, like data about [global coups or student loan debt](https://tinyletter.com/data-is-plural/letters/data-is-plural-2020-12-02-edition), and others, like the [surprisingly large number of databases](https://tinyletter.com/data-is-plural/letters/data-is-plural-2020-12-09-edition) dealing with [different aspects of Bob Ross paintings](https://fivethirtyeight.com/features/a-statistical-analysis-of-the-work-of-bob-ross/), are just delightful.

[Sherrell Dorsey](https://www.sherrelldorsey.com/') spoke with Singer-Vine spoke about his approach to journalism and leadership, how he finds interesting data sets, and what he sees as the surprising success of Data is Plural.

**Can you give us an example of how the work you do, and your approach to it, is changing data journalism?**

One thing we've been very focused on at BuzzFeed News since the formation of this data team is [showing as much of our work as possible](https://source.opennews.org/articles/what-weve-learned-about-sharing-our-data-analysis/). That often means publishing [GitHub repositories](https://techcrunch.com/2012/07/14/what-exactly-is-github-anyway/) that include all of [our analytic code](https://github.com/BuzzFeedNews/everything), plus whatever data we're able to release, plus methodologies that explain our approach.
...
I didn’t have a computer science background—I studied liberal arts in college. I maybe played around with HTML and knew a line or two of JavaScript, but I would say I was underexposed to computer programming. But after college I had an internship at [Slate Magazine](https://slate.com) where I was seeing all of the amazing things that [my supervisor, Chris Wilson](https://mechanicalscribe.com/about.html), could do with just a little bit of programming. And that was exciting to me.
...
**Earlier you mentioned reusability and the idea of transmission of data to other journalists. That’s at the core of your personal newsletter, [Data is Plural](https://tinyletter.com/data-is-plural), which is a weekly collection of data sets. Tell me about how you created your newsletter, how long you've been running it and why.**
...
When I first launched I thought it would be nice to get 100 subscribers. It's so hard to accumulate any large audience for anything. I might have underestimated people’s interest in learning about new data sets, I thought it was maybe more of a niche thing. It turns out to be something that, to my happy surprise, people from all fields—students and artists and academics in the humanities and sciences—find exciting, even if not every data set in the newsletter is relevant to them. And now it's about [23,000 subscribers](https://github.com/data-is-plural/newsletter-stats).

**How do you source your data sets? **

It's a mix of Google Scholar alerts on keywords about data sets, subscribing to other data related newsletters, subscribing to scientific journals that focus on data, like [Scientific Data](https://www.nature.com/sdata/), a bunch of blogs and RSS feeds, a few carefully tailored Twitter searches. Then a lot of people, thankfully, reaching out to me directly. That's always exciting—to hear about something that I would have had virtually no way of discovering if it were not for a reader alerting it to my attention.

There's also a more amorphous way of sourcing. As I'm reading the news, I might wonder to myself, *what is the data set behind tha*t? If I see an article that talks about the number of [Christmas trees being harvested](https://www.nbcnews.com/news/us-news/map-christmas-tree-farms-data-north-carolina-oregon-2018-n946776) in each state, I try to figure out the source. Sometimes a news article will say what the sources are, other times it might take some creative Googling, and trying to imagine where the data lives.
...
*This was a conversation between [Sherrell Dorsey](https://www.sherrelldorsey.com/) and [Jeremy Singer-Vine](https://www.jsvine.com/), edited for length and clarity by [Annaliese Griffin](https://www.linkedin.com/in/annaliesegriffin/) and [Rachel Jepsen](https://twitter.com/DidYouWriteThat). *

---

#### What’d you think?

[Amazing](https://docs.google.com/forms/d/e/1FAIpQLSeec6exXul4DBcrQMufylLdlbOft0oSqXohVDSSS6Xi5IQumQ/viewform?usp=pp_url&entry.1290442430=Amazing) • [Good](https://docs.google.com/forms/d/e/1FAIpQLSeec6exXul4DBcrQMufylLdlbOft0oSqXohVDSSS6Xi5IQumQ/viewform?usp=pp_url&entry.1290442430=Good) • [Meh](https://docs.google.com/forms/d/e/1FAIpQLSeec6exXul4DBcrQMufylLdlbOft0oSqXohVDSSS6Xi5IQumQ/viewform?usp=pp_url&entry.1290442430=Meh) • [Bad](https://docs.google.com/forms/d/e/1FAIpQLSeec6exXul4DBcrQMufylLdlbOft0oSqXohVDSSS6Xi5IQumQ/viewform?usp=pp_url&entry.1290442430=Bad)

---

#### Free Radicals celebrates leaders who embrace new ideas and cultivate forward momentum. Subscribe to keep listening in on how change happens.

[Subscribe now](https://free-radicals.every.to/subscribe?)
