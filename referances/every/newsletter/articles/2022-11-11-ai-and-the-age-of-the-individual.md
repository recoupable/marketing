...
subtitle: "When intelligence is cheap, individuals win"
author: "Dan Shipper"
date: 2022-11-11
column: chain-of-thought
url: https://every.to/chain-of-thought/ai-and-the-age-of-the-individual
paywalled: true
scraped_at: 2026-06-11T16:08:29.481Z
---
...
This essay is brought to you by [Akiflow](https://akiflow.com/?utm_source=newsletter&utm_medium=every&utm_campaign=november), the ultimate time-blocking platform. [Akiflow](https://akiflow.com/?utm_source=newsletter&utm_medium=every&utm_campaign=november) consolidates all your tools in one place and blocks time for your tasks in your calendar.

[Try Akiflow for Free](https://akiflow.com/?utm_source=newsletter&utm_medium=every&utm_campaign=november)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#4330332c2d302c31302b2a333003263526313a6d372c).

People think [AI](https://every.to/c/ai-and-gpt3) is going to replace individuals and create gigantic trillion dollar megacorporations that will upend Google. But I think there’s a strong case to be made that rather than replacing individuals, recent advances in AI will *empower* them to make an impact on a scale matching some of the biggest businesses, research labs, and creative organizations of today.
...
Take someone like [Ryan Holiday](https://twitter.com/RyanHoliday). Ryan runs:
...
For one, text-based large language models are already quite good at filling a research assistant or co-writer role. They’re happy to help look up facts and quotes, or to create an outline based on a simple idea. Of course, they’re not as good as a human at these tasks yet—but they’re good enough to have changed my writing process already through [Lex](http://lex.page/), and their rate of improvement is high enough that in a year or two I think we’ll be shocked that we ever wrote without them. Going back will feel like trying to hike a mountain in high heels.

But that’s just how these tools will change the actual writing. They’ll also change writers’ ability to produce content for different formats. Text to speech models are *already* able to turn essays into human-like narration—just check out tools like [Murf.](https://murf.ai/)

Video is a tougher nut to crack, but it’s definitely on the way. It’s already trivial to turn text into images using DALL·E and Stable Diffusion. It’s also trivial to use AI to [interpolate between two images](https://ai.googleblog.com/2022/10/large-motion-frame-interpolation.html) to create a rough animation. Tools like [Runway](https://runwayml.com/)are advancing rapidly in this space—and I don’t see any reason why these models won’t be able to create high-quality, format driven YouTube videos from an essay in a few years.
