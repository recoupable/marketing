---
title: "Vaxx to the Future"
subtitle: "It's the April 2021 Prediction Game Update"
author: "Andre Plaut"
date: 2021-04-16
column: the-prediction-game
url: https://every.to/the-prediction-game/spring-is-here
paywalled: false
scraped_at: 2026-06-11T16:09:01.311Z
---
...
*Welcome to the Prediction Game. In December, over 1,000 participants filled out 20 questions to predict the future in 2021. We'll be following up and tracking those predictions as the year unfolds. We’re also exploring the science and mysticism of predicting the future. Our first spotlight on how to predict the future can be found *[here](https://every.to/the-prediction-game/how-to-see-the-future-like-a-superforecaster-8313)*.*
...
The federal government has also significantly stepped up the production, distribution, and administration of COVID vaccines, which means we hit our goal of **100 million doses of vaccine administered by March**. That’s one month earlier than most people predicted! Big win for public health, big loss for many Prediction Game participants. We’re on track to hit 200 million doses very soon, and[you can be a part of that historic milestone if you haven’t gotten vaccinated yet!](https://www.nbcnews.com/specials/plan-your-vaccine/)
...
While not related to any predictions, we’ve also seen a number of all *too predictable* events take place over the last few months across the US in terms of [gun violence](https://www.everytown.org/), [violence against the Asian-American and Pacific Islander community](https://stopaapihate.org/), and [police brutality against Black people](https://eji.org/). We may be near the end of one long pandemic, but these events are part of a larger pandemic that has raged on for decades. You can use the links above to learn more about the issues and get involved.
...
[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1625/optimized_Every%20Index%20April%20Update.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1625/optimized_Every%20Index%20April%20Update.png)

The *Every Index *is absolutely tearing it up, or as the kids say these days 🚀🚀🚀. As a reminder, the *Every Index *is our $1,000 fund invested by friends of Every, and the prize for winning The Prediction Game. It is currently up 34% largely thanks to [Sari Azout](https://twitter.com/sariazout) and [Seyi Taylor](https://twitter.com/seyitaylor) who both chose Ethereum, our best performing asset with 218% gains. Although, to be honest, I kinda wish someone had gone all in on Dogecoin.
