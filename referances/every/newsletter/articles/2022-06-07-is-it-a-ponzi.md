---
title: "Is it a Ponzi? "
subtitle: "A framework for evaluating crypto projects"
author: "Nat Eliason"
date: 2022-06-07
column: almanack
url: https://every.to/almanack/is-it-a-ponzi
paywalled: false
scraped_at: 2026-06-11T16:08:37.124Z
---
...
[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#b5c6c5dadbc6dac7c6dddcc5c6f5d0c3d0c7cc9bc1da).
...
[Bernie Madoff's Ponzi scheme](https://en.wikipedia.org/wiki/Madoff_investment_scandal) is perhaps the best known and strongest example. He was committing fraud by faking trades to explain the source of profits when in reality he was recirculating money from later investors to earlier ones. He was running an investment business, but some of the returns were fabricated.
[Bitconnect](https://en.wikipedia.org/wiki/Bitconnect) is probably the most famous Ponzi scheme we've seen in crypto yet. They were promising 1% compounded returns per day, which turned out to be coming from other people putting money into the system.
...
1. Who’s spending money

2. How much

3. Is there a way for this spending to exceed the project’s expenses

And at least in the crypto realm, this typically means there needs to be some spending of tokens or assets that are not the native ones. This is a challenge many games can run into that I outlined in the [One vs. Two Token](https://crypto.nateliason.com/p/one-vs-two-tokens) article. If a game is making all of its money in their token, they then have to figure out how to dump their token on the market to actually collect that revenue. Spending something else like ETH or USDC is more legitimate.
...
WeWork is a decent example of this. Benchmark initially invested $17m in WeWork, and later sold some of that investment[for $315m](https://news.crunchbase.com/news/report-adam-neumann-benchmark-unloaded-676-5m-in-wework-shares-before-failed-ipo/). If WeWork was an unsustainable business, where the early investors were getting paid off by later investors, was it a Ponzi scheme?
...
In [my STEPN article](https://crypto.nateliason.com/p/stepn), my biggest criticism was that their minting program would create runaway inflation eventually devaluing the sneakers and tokens. I also argued that their GMT token was massively overpriced and had no cash flows or revenue associated with it to justify the price.
...
*Thank you *[Wikipedia](https://upload.wikimedia.org/wikipedia/commons/6/66/Charles_Ponzi.jpg)* for the photo of Charles Ponzi*
