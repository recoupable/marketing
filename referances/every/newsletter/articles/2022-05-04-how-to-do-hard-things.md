...
subtitle: "A founder explores his journey with Acceptance and Commitment Therapy (ACT)"
author: "Casey Rosengren"
date: 2022-05-04
column: no-small-plans
url: https://every.to/no-small-plans/how-to-do-hard-things
paywalled: false
scraped_at: 2026-06-11T16:08:39.246Z
---
...
I'd always been a bit of a psychology nerd (I originally got into meditation after reading a meta-analysis of its positive effects), and one day I stumbled upon a book, [Values in Therapy](https://www.amazon.com/Values-Therapy-Clinicians-Psychological-Flexibility-ebook/dp/B07MT7DW5T), that explored a little-known framework from behavioral psychology that was a lightbulb moment for me. It finally helped me understand why I was so unhappy running my last company, and I finally began to see how I might be able to approach the stress and uncertainty of entrepreneurship in a new way: one that was life-giving instead of soul-sucking.
...
In talking with friends—both founders and non-founders—I realized that a lot of people go through what I went through, and that what helped me could also help others. I started devouring books and research on ACT, and eventually trained in how to use it with others in [a coaching context](https://www.nosmallplans.io/) (when it's not therapy, we call it Acceptance and Commitment Training and still abbreviate it as "ACT").
...
Later in life, when I started a company, I still had to contend with this rule. When a growth experiment didn't work, or a strategic decision didn't pan out, I felt it viscerally: "I did something wrong. I must be bad at this."
In real life, however, and especially in entrepreneurship, we aren't taught the right answers before we're faced with a challenging situation. Even though the context of my life had changed from school to entrepreneurship, this thought was still popping up as a guiderail for my behavior. The problem was that it was hard for me to enjoy work when I often felt like I was doing something wrong. It caused me to avoid doing things where I might mess up—which is a precarious way to run a company, because those situations are a constant part of life.
...
Now, to some degree, it's useful to be able to imagine and plan for what might go wrong in the future, or recall lessons from a painful moment in the past. The [stress response is built to get us out of danger](https://every.to/superorganizers/how-hard-should-i-push-myself)–in the words of Andy Grove, "Only the paranoid survive." However, there comes a point where [ruminating over the past or worrying about the future no longer pays dividends](https://every.to/superorganizers/will-worrying-make-you-better), making it hard to find meaning in one's work in the present.
...
Then, toward the end of last year, I was talking with [Dan](http://www.twitter.com/danshipper), and it turned out that we both wanted to bring more consistency to our writing process. We decided to start meeting daily in the mornings for 2-3 hours of writing, and it turned out to be a gamechanger for both of us. Even when we’d miss a day, since we enjoy hanging out, we’d show up the next day  and push through the resistance to starting again.
...
-
[A Liberated Mind](https://www.amazon.com/dp/B07LDSPRYM/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1), also by Steve Hayes, is a self-help book that gives a more in-depth overview of the ACT model and includes a number of exercises to do on your own. If you'd like to get a taste of what the book is like, Steve has a number of exercises you can try [on his site](https://stevenchayes.com/my-act-toolkit/).

-
[Values in Therapy](https://www.amazon.com/Values-Therapy-Clinicians-Psychological-Flexibility-ebook/dp/B07MT7DW5T), by Jenna LeJeune and Jason Luoma, is my favorite book on ACT, and explores the processes above with a focus on how they all relate to values. Although this book is meant for clinicians, I've found it accessible for anyone interested in ACT.

- There are also many posts in Every that directly, or indirectly, reference the principles of ACT like Dan's recent [piece on panic attacks.](https://every.to/superorganizers/how-to-do-hard-things)
