...
subtitle: "The case for maximizing meaning, not efficiency"
author: "Rhea Purohit"
date: 2025-09-23
column: learning-curve
url: https://every.to/learning-curve/you-re-probably-using-ai-wrong-dff84293-9edc-4da5-8732-71bd8d5d5b96
paywalled: true
scraped_at: 2026-06-11T16:07:34.108Z
---
...
*Using AI is an exercise in meta-thinking. At Every, that often means writing about what it means to write with AI. Among our recent pieces, we've talked about [how to build an AI writing partner](https://every.to/working-overtime/i-fed-my-essays-to-chatgpt-until-it-learned-my-voice), [the benefits of using AI voice-to-text tools](https://every.to/working-overtime/i-didn-t-know-typing-held-me-back-until-i-started-thinking-out-loud), and how to [preserve a unique writing style while using AI](https://every.to/working-overtime/how-to-keep-your-writing-weird-in-the-age-of-ai). Today we're re-surfacing a [perspective](https://every.to/learning-curve/you-re-probably-using-ai-wrong) from ****Rhea Purohit****, who after struggling to work AI into her day-to-day routine found success when she began using it not for high-volume productivity, but to amplify meaning in her work and life.—[Kate Lee](https://every.to/news/kate-lee-joins-every-as-editor-in-chief)*
...
As humans, we are drawn to activities that give us meaning. In some domains of life—like, say, mountaineering—this may seem obvious. As an example, take the [Eiger](https://en.wikipedia.org/wiki/Eiger#North_face), a 13,000-foot high peak in the Swiss Alps.

The [north face](https://en.wikipedia.org/wiki/Eiger#/media/File:Eiger_north_face_diagram.jpg) of the Eiger—a vertical wall of ice and limestone—has earned the moniker Mordwand, German for “murder wall,” because of the number of people who have died trying to climb it.

A third of the way up the jagged mountain, at around 9,000 feet, is a [door](https://www.europebyrail.eu/a-hole-in-the-wall/).
