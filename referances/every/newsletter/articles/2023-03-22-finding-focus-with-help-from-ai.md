---
title: "Supercharging My Focus (with Help from AI)"
subtitle: "GPT-powered journaling is changing my life"
author: "Nathan Baschez"
date: 2023-03-22
column: divinations
url: https://every.to/divinations/finding-focus-with-help-from-ai
paywalled: true
scraped_at: 2026-06-11T16:08:23.066Z
---
...
1. DISTRACTION: Impulses to do things that are not within the area I have chosen—or been assigned—to focus on.

2. DISINTEREST: Sometimes there is just nothing attractive about my area of focus. It’s not that I have an urge to do something else, it’s just that I’ve lost interest. Sometimes this is temporary burnout, but other times it’s a sign of something deeper.

Based on these two failure modes, it would seem that the central challenge of increasing focus is:

1. To avoid temptations

2. To do the things we’re supposed to, even when we don’t want to
