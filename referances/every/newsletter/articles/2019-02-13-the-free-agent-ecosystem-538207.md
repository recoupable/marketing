...
date: 2019-02-13
column: forte-labs
url: https://every.to/forte-labs/the-free-agent-ecosystem-538207
paywalled: false
scraped_at: 2026-06-11T16:09:36.925Z
---
...
As attractive and compelling as it is to be a [full-stack freelancer](https://fortelabs.co/the-rise-of-the-full-stack-freelancer-c14a375445d9/), there are three significant downsides that can’t be addressed without collaboration:
...
One of the most interesting models I’ve come across is the Free Agent Ecosystem (FAE), a framework that describes a “sustainable, commercial ecosystem among collaborating professional services free agents.” It was first published in 2001 in a [working paper](https://static1.squarespace.com/static/5659f669e4b0f60cdbb12aa8/t/5ace41c30e2e72484fea7026/1523466729545/Free+Agent+Ecosystem+Manifesto+v8+2017.pdf)1 written by a group of innovation and business consultants led by Joseph B. Sterling of [Rainforest Strategies](http://rfs-llp.com/), along with Dr. Karen Dietz, Sharon Lieder, and Rita L. Sterling.
...
[![](http://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/831/optimized_aa1086f1-5d5c-4761-871e-e45bdfa57592_900x506.jpeg)](http://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/831/optimized_aa1086f1-5d5c-4761-871e-e45bdfa57592_900x506.jpeg)
...
The second main component of FAE is drawn from the study of complex adaptive systems:

*“An easy to understand way of describing a complex adaptive system follows: Many individual agents following **a few simple rules which, when played out across the entire population, generates the emergent behavior of the whole**(colony or hive). Frequently this emergent behavior is surprising and cannot be predicted by looking at the behavior of the individual agents.”*
...
The first rule is to reward any behavior that contributes to sales. What constitutes “sales” is so fuzzy and subjective, from a conversation over coffee to a card at the holidays, that it can be difficult to incentivize it directly.

The referral fee is only paid if the contract is signed somewhere down the line, so the incentive is for the referrer to position the Prime Contractor in the most positive light possible. The paper notes that “No amount of money will buy this from any marketing consultant or ad agency over the long haul.” The referral fee is thus low enough to discourage bad faith referrals, yet high enough to reward behavior that might happen in the course of existing relationships.
...
If an ecosystem of free agents was truly thriving, a given subcontractor would often find themselves working with different Prime Contractors. This raises some interesting dilemmas:

- Whose business card do I present today?

- Will presenting my own business card confuse the issue?

- Will that give the client the notion that the Prime and I are potential competitors?
...
This background knowledge could include:

- A client or prospect’s contact information

- The source of the lead

- The history of contacts with the lead/client

- Transaction details and documents

The same is true of “content knowledge” accumulated during the course of the project, such as:

- Knowledge byproducts produced and used before, during, and after an engagement
...
This rule has long been a part of business culture, but in a free agent ecosystem it gains teeth. Since a Prime today could be a subcontractor tomorrow, it becomes important to accrue “goodwill points” from everyone you work with, not just your superiors. You never know from where the next opportunity will come.

FAE effectively creates a marketplace of buyers and sellers, bringing fairness and transparency to the world of high-end professional services that has for so long been cloaked in secrecy. In such an open marketplace, information travels at the speed of light, and a free agent’s choices become a matter of public record very quickly. No performance management system in the world moves this fast.
...
The third major component of FAE is a set of templates for defining and managing the roles within the value chain.
...
# Knowledge Management in a Free Agent Ecosystem
...
I believe that such an ecosystem could also resolve long-standing challenges in knowledge management. Knowledge management within organizations has failed to live up to its potential mainly for one simple reason: it’s not needed.

When you know you have the same set of people available in the same place (physical or virtual), it is just not worth the time to externalize and document one’s knowledge. Human beings will always be a far, far more effective interface to their own knowledge than any wiki, knowledge base, or database. No knowledge repository will ever be able to compete with the convenience and speed of pinging someone on one of the dozens of communication channels we now have available.

Interestingly, this doesn’t change with the rise of remote, distributed, asynchronous teams. As long as that person and their knowledge remain available to you in a reliable way, it makes more sense to contact them directly than to access any “knowledge artifacts” they’ve created. Which means, of course, that they won’t bother to create them in the first place.
...
[Click here to view the original Free Agent Ecosystem working paper and a slide deck explaining the framework](https://www.evernote.com/l/AMyAXraViFhGZaogQlBywAG5RNQahXHxung)

1. © 2001-2017 by Rainforest Strategies, LLP., Polaris Associates, LLC and Lieder Group
