...
subtitle: "An expansive question that has surprisingly practical value"
author: "Nathan Baschez"
date: 2022-09-13
column: divinations
url: https://every.to/divinations/what-is-a-business
paywalled: false
scraped_at: 2026-06-11T16:08:32.304Z
---
...
This essay is brought to you by [Prequel’s Creators Bootcamp](https://joinprequel.com/creators?utm_source=partners&utm_medium=email&utm_content=every_divinations_ad), where teens learn how to build a social media following and use it to create a world-class network.

[Learn More](https://joinprequel.com/creators?utm_source=partners&utm_medium=email&utm_content=every_divinations_ad)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#0477746b6a776b76776c6d747744617261767d2a706b).
...
Traditional networking is dying. Remote work and the scale of the internet mean that the networks of tomorrow are being built on social media. [Prequel’s Creator Bootcamp](https://joinprequel.com/creators?utm_source=partners&utm_medium=email&utm_content=every_divinations_ad) teaches teens how to build and scale a social media audience from scratch and how to leverage it to access exponential opportunities.

The [bootcamp](https://joinprequel.com/creators?utm_source=partners&utm_medium=email&utm_content=every_divinations_ad) is developed in partnership with world class creators with millions of followers combined across all major social media platforms—from LinkedIn to Instagram.

[Prequel](https://joinprequel.com/creators?utm_source=partners&utm_medium=email&utm_content=every_divinations_ad) shows middle and high school students how to create content with career goals in mind and start building reputation and authority online so that they can create their first revenue stream, access coveted job opportunities, and find top-tier mentors.

[Join a free workshop to learn more](https://joinprequel.com/events?utm_source=partners&utm_medium=email&utm_content=every_divinations_ad)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#95e6e5fafbe6fae7e6fdfce5e6d5f0e3f0e7ecbbe1fa).

## 2

If you want to understand the nature of something, it helps to go back to when it originally emerged to understand why. So here’s a passage from [The Origin of Wealth](https://www.amazon.com/Origin-Wealth-Remaking-Economics-Business/dp/1422121038)* *that tells the story of the very first business:
“About 2.5 million years ago, *Homo habilis* began to use its relatively large brain to begin making [crude stone tools](https://en.wikipedia.org/wiki/Oldowan). We can think of these stone tools as the first products, and we can imagine that at some point two of our hominid ancestors, probably from the same band of close relatives, sat in the dust of the savanna and traded tools. We will use this very approximate point of 2.5 million years ago as the market for the beginning of the human ‘economy’.”
...
Walter Lippmann [described](https://www.theatlantic.com/magazine/archive/1936/11/the-government-of-posterity/652211/) this perfectly in a 1936 edition of *The Atlantic*:
...
1. A way to generate new things

2. An environment in which those things can succeed or fail

3. A way for successful things to spawn new imperfect copies of themselves
...
A business is a pattern of economic activity that is stable through time. The pattern of activity is the DNA of the business. This is what I am talking about when I talk about “strategy”. It’s the activities the business chooses to do. (This is also Harvard strategy legend [Michael Porter’s definition](https://hbr.org/1996/11/what-is-strategy).)
...
- “We’re a photo sharing network, but you can only share once a day.” ([BeReal](https://every.to/divinations/bereal-should-beworried))

- “We’re a podcast app, but everyone listens live and can be invited to speak.” ([Clubhouse](https://every.to/p/what-i-learned-at-clubhouse))

- “We’re a computer, but strapped to your eyeballs” ([Oculus](https://every.to/napkin-math/the-meh-taverse))

- “We’re a payments processor, but for web developers” ([Stripe](https://every.to/p/what-i-miss-about-working-at-stripe))
...
1. Upstream: As the new business grows, it runs into new needs that can be served by new types of suppliers. For example, computer hardware companies created the opportunity for software specialists. Software companies created the opportunity for coding bootcamps, etc.

2. Downstream: As people use the new technology, it alters their behavior in ways that create opportunities for complements (e.g. cars leading to fast food).

3. Parallel: When a new business works in one domain, it implies similar businesses might work in other domains. This is why a breakout success is often followed by imitators with a slight twist.
