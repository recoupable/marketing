---
title: "Mo’ Founders, Mo’ Problems"
subtitle: "Cofounder drama is the secret startup killer"
author: "Jennifer Kim"
date: 2023-10-23
column: p
url: https://every.to/p/mo-founders-mo-problems
paywalled: false
scraped_at: 2026-06-11T16:08:11.148Z
---

# Mo’ Founders, Mo’ Problems

*Cofounder drama is the secret startup killer*
...
- The duo’s cycle can get very entrenched, so the key is to interrupt it. Work with a founder coach ([I can share referrals](https://www.workflowhq.com/contact)). Hire a strong, *experienced* COO. Both resources, much like a couples therapist, can act as a neutral third party. Ideally, you can invest in this early, before the high-stakes pressure makes the conflict untouchable.

## Trio (3) founders

**The dysfunction loop: **Constant [clanning](https://personalmba.com/clanning/), influenced by the human tendency to organize into “us” versus “them,” leading to insecurity and infighting that distracts from actual building.

##### What it looks like:

- Much like the “[three-body problem](https://en.wikipedia.org/wiki/Three-body_problem)” found in physics, the trio is inherently unstable. One is almost always “left out,” while the other two come together. These roles are constantly in flux.
...
[Jennifer Kim](https://www.linkedin.com/in/jenistyping/)* (@jenistyping) is the founder and CEO of *[Workflow](https://workflowhq.com/)*, an education and consulting company that trains the next generation of startup leaders on recruiting, people ops, and DEI. She is also a venture partner at Symphonic Capital, and previously was head of people at Lever. She writes a weekly newsletter about the human side of startup building, *[Safe for Work](https://safeforwork.substack.com/)*, where this piece was *[originally published](https://safeforwork.substack.com/p/005-mo-founders-mo-problems-startup)*.*
