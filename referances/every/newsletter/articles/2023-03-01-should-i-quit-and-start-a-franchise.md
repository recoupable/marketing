---
title: "Should I Quit and Start a Franchise?"
subtitle: "I’m wondering if I can deep-fry my way out of the apocalypse"
author: "Evan Armstrong"
date: 2023-03-01
column: napkin-math
url: https://every.to/napkin-math/should-i-quit-and-start-a-franchise
paywalled: true
scraped_at: 2026-06-11T16:08:23.712Z
---
...
I’m being a little facetious, but AI making knowledge workers redundant is happening right now. My sense is that, even with all the hype, analysts are *still* underestimating how disruptive these text-generation models are. In my research, I’ve held calls with doctors, university professors, engineers, salesmen, and magazine editors. They all confess, in hushed tones, that they are secretly using ChatGPT to do some of their work for them. None of their colleagues have been able to tell though. (My guess is that their colleagues are secretly doing the same.) It has allowed them to do less work while receiving the same pay. In fact, a working paper out of MIT came out this morning showing an experiment where white collar workers given access to ChatGPT finished a task [35%](https://t.co/3sVfAOAshv) faster.

In my first [piece](https://every.to/napkin-math/when-creation-goes-to-zero) on this new tech, I argued that “AI takes content creation to zero.” At the time, most of my readers took me to mean that content creators would become unemployed. This is not an expansive enough view. A more accurate way to think about it: If you type on a keyboard, AI makes you redundant.

In the short term, it will only make* some* of us less redundant. Think of it in terms of farming—in 1850, farm labor was [4.9M](https://www.nytimes.com/1988/07/20/us/farm-population-lowest-since-1850-s.html) people, or **~64%**, of the U.S.'s 7.7M workers. Today, there are only [2.6M](https://www.ers.usda.gov/data-products/ag-and-food-statistics-charting-the-essentials/ag-and-food-sectors-and-the-economy/) farmers, or 1.3% of the United States labor force, but these farmers make exponentially more food using modern technology such as tractors, GMOs, etc. A similar phenomenon applies to anyone who types for a living. Much fewer people will be required to create even more output than before.
...
This is not a stock. This is what is required to be a franchisee. You would likely respond to my proposition, “I do not want to do that thing because I do not snort glue.” (Wise response.) However, someone has made this exact choice [498,234](https://www.census.gov/library/stories/2021/12/franchising-is-more-than-just-fast-food.html) times in the United States.
