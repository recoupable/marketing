---
title: "A Non-Definitive Guide to Non-Duality"
subtitle: "A primer on unsplintering your reality"
author: "Sasha Chapin"
date: 2023-06-19
column: p
url: https://every.to/p/a-non-definitive-non-guide-to-non-duality
paywalled: false
scraped_at: 2026-06-11T16:08:17.855Z
---
...
*Editor's Note: Hey! *[Dan](https://twitter.com/danshipper)* here. Generally, at Every we try to stick to writing that's directly written for founders, operators, and investors in tech. We break this rule on two occasions: for pieces that are really good, or really important. This piece ticks both of those boxes for me.*
...
Also, quick warning. [Any kind of meditation can be mentally destabilizing,](https://vividness.live/meditation-risks) particularly if done in large doses (and especially if you’re currently not doing well mentally).  I believe that it’s very unlikely that a brief interaction with meditation instructions will be destabilizing, but it’s possible.
...
If you intend to dive deep into any contemplative practice, it’s worth taking a look at [Cheetah House’s material](https://www.cheetahhouse.org/), or at least bookmarking it. It’s an organization devoted to helping meditators who have adverse experiences. Also, a friend of mine reported that the book [Trauma-Sensitive Mindfulness](https://www.amazon.com/Trauma-Sensitive-Mindfulness-Practices-Transformative-Healing/dp/0393709787) was helpful for him after a disruptive meditation experience, especially [this passage](https://docs.google.com/document/d/10V6ZV89qwgdm83RgVRD6b5fvKAQPB8Ku02Pz87Sil8s/edit).
...
-
**"Sacred” and “profane” **by trying to see beauty or even dignity in what we might normally regard as ugly or undignified—and/or, if you’re a religious type, seeing the presence of God in everything, a la [Meister Eckhart](https://en.wikipedia.org/wiki/Meister_Eckhart) or [Advaita Vedanta](https://en.wikipedia.org/wiki/Advaita_Vedanta).
...
-
**"Form” and “emptiness” **which is… hellaciously hard to explain and will be pretty arcane to most readers, but something *kind of like*: “Reality is a subjective fluctuating dance of ephemera which we never see the objective bottom of, like flashes on a screen. But this doesn’t mean it’s *unreal, *in fact, that ephemeral dance is, itself, the miraculous substance of existence.” Note that this is a weird Buddhist thing that weird Buddhists have been arguing about forever; if you want more on this, I like David Chapman’s writing, which relabels the duality “[pattern](https://meaningness.com/pattern) and [nebulosity](https://meaningness.com/nebulosity).”
...
Another thing I’ve heard good reviews about, but haven’t played with too much, is Connirae Andreas’ [Wholeness Work](https://www.amazon.com/Coming-Wholeness-Awaken-Live-Ease-ebook/dp/B07JD89Z32/ref=sr_1_1?crid=3KK1D11071URA&keywords=connirae+wholeness&qid=1676157319&sprefix=connirae+wholenes%2Caps%2C138&sr=8-1). She is the inventor of Core Transformation, an emotional work modality I think is fairly effective.
**6.** [Self-inquiry](https://www.siftingtothetruth.com/blog/2019/6/7/the-ultimate-guide-to-spiritual-self-inquiry)
Some teachers, such as [Ramana Maharshi](https://www.sriramanamaharshi.org/), recommend “self-inquiry” practice, an investigative meditation in which you ask yourself questions like: “Who am I?” or “Who is having this experience?” You then look for the answer—not the *factual *answer, but the *felt *answer. Like: allow yourself to notice that you exist right now. What was the feeling of noticing that you exist, the feeling of “I am”?
...
**7.** [Headless Way](https://www.headless.org/)
The Headless Way is a really fun and funny set of pointing out instructions with an Alice in Wonderland aesthetic, which feel very different from traditional meditation stuff. There’s a great Headless Way course on the Waking Up app. Some people find [this exercise](https://www.headless.org/experiments/pointing.htm) especially psychoactive.
**8.** [Alexander Technique](https://expandingawareness.org/)
Alexander Technique is best known as a weird posture thing that is taught to actors. But in the hands of some teachers, it’s a practice of expanded awareness that gets you to a flavor of non-duality in a couple of ways, like deconstructing your experience of moment-to-moment volition, untraining your habitual contractions of awareness, and freeing you from needless “efforting” in movement. I really enjoy [my friend Michael’s course](https://expandingawareness.org/courses/) on this.
...
1. Try to figure out where your “sense of self” is located. Like when you say “I’m here,” what is that referring to, specifically?

2. Like: if you have the intuition that you are looking out from inside your head, what sensations is that intuition constructed from? The feeling of something “back there,” in space, behind the lens of vision? Does this feeling have a texture, a shape, or a size? Or is it just a vague sense of *something?*

3. Can you examine that sense itself, by asking, “Where am I?” Then make the answer an object in consciousness.

4. If you pick up on anything: great. Hold it there for a second.

5. Then: play with the idea of allowing that* *object—that felt sense of self—to expand. See if you can let it stretch out into your awareness of the space around you.
...
Interestingly, there can be a feedback loop effect, too: I’ve heard many reports of people having spontaneous non-dual experiences upon making therapeutic breakthroughs, or having an easier time with non-dual practice after [resolving trauma](https://sashachapin.substack.com/p/how-i-wish-trauma-had-been-explained).
...
This might sound totally crazy if you haven’t hung around communities of people who meditate. But it’s happened to many, many people. For example, [it actually happened to me](https://sashachapin.substack.com/p/when-my-existence-inverted-instantly). It did not give me superpowers, but my life is definitely more pleasant after it.
This permanent erosion of the self-other boundary, by the way, is far from being the “end” of non-dual practice. There are many refinements beyond it, and I am told there is no bottom, no capital-e Enlightenment after which there’s nothing more to learn. (I like [Ken McLeod’s take](https://www.youtube.com/watch?v=_tOfwk0r8UY) on this.)
...
[This paper](https://www.frontiersin.org/articles/10.3389/fnhum.2011.00183/full), for example, is almost too convenient and cute in the story it tells. Roughly: fMRI imaging of meditators doing non-dual practice suggests that non-dual meditation is associated with increased activity in normally anti-correlated regions of the brain.
...
I don’t know. But here is one interesting hypothesis, based on an off-hand remark by Alexander Technique teacher [Peter Nobes](https://www.alexandercentre.co.uk/), who, during a lesson, said something to me like, “If you’re on the savannah, you will starve if you’re blocked off from perceiving and acting freely.”
...
So this is a miracle, right? As my friend [Hormeze](https://hormeze.com/) says, it’s a stroke of cosmic luck that we can build up this complicated self-model, and then transcend it through non-dual experience. We can have it both ways.
...
[This post](https://smoothbrains.net/posts/2022-08-24-planetary-scale-vibe-collapse.html), which I stumbled on recently, is a further exploration of the hypothesis that primitive humans possessed less duality. I have no idea whether to believe it, it’s just a fun idea.
...
[Qualitative research](https://digitalcommons.ciis.edu/conscjournal/vol8/iss8/1/) has shown that people who have persistent experiences of non-duality tend to keep a lot of to-do lists, for this reason.
...
[Michael Taft’s Non-Duality Page](https://deconstructingyourself.com/nonduality)
...
[I Am That](https://www.amazon.com/I-Am-That-Nisargadatta-Maharaj/dp/0893860468)
...
[Roaring Silence](https://www.amazon.com/Roaring-Silence-Discovering-Mind-Dzogchen/dp/1570629447)
...
[A Cartoon Epistemology](http://slehar.com/wwwRel//cartoonepist/cartoonepist.html)
This is a whimsical and disorienting graphical exploration of the stitched-together strangeness of consciousness.
[An Experience of Enlightenment](https://terebess.hu/zen/mesterek/FCourtois.pdf)
...
[PNSE Paper](https://nonsymbolic.org/PNSE-Article.pdf)
...
*Thank you, eternally/non-eternally, to *[Cate Hall](https://twitter.com/catehall)*, *[Katja Grace](https://worldspiritsockpuppet.substack.com/)*, *[Mister](https://hormeze.com/)* *[Hormeze](https://twitter.com/hormeze/)*, Derek Razo, *[Milan Griffes](https://twitter.com/MilanGriffes)*, and *[Natalie Cargill](https://www.nataliecargill.com/) *for your help with this piece.*

---

[This post originally appeared on Sasha's Newsletter.](https://sashachapin.substack.com/p/a-non-definitive-non-guide-to-non)
*Sasha Chapin is a writer who lives, with some reluctance, in the Bay Area. His *[newsletter](https://sashachapin.substack.com/)* is the best way to find more of his writing, and his *[Twitter](https://twitter.com/sashachapin)* is a source of something or other. He is the author of a *[memoir](https://www.amazon.com/All-Wrong-Moves-Sasha-Chapin-audiobook/dp/B07RJZ925V/ref=sr_1_1?crid=LEWGQUKVYOD2&keywords=all+the+wrong+moves&qid=1683573914&sprefix=all+the+wrong+move%2Caps%2C158&sr=8-1)* about being bad at chess.*
