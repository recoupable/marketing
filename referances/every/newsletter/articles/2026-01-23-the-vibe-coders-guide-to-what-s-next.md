---
title: "The Vibe Coders’ Guide to What’s Next"
subtitle: "Plus: Why prompt engineering belongs in business school"
author: "Every Staff"
date: 2026-01-23
column: context-window
url: https://every.to/context-window/the-vibe-coders-guide-to-what-s-next
paywalled: false
scraped_at: 2026-06-11T16:07:24.823Z
---
...
*Hello, and happy Sunday! Last week we hosted a two-day vibe coding extravaganza: On Thursday, some of the world’s best vibe coders were in action at a marathon [Vibe Code Camp](https://www.youtube.com/live/5YBjll9XJlw) (more on that below), followed by our first ever [Agent-native Camp](https://www.youtube.com/watch?v=LP0kt7duSwk) on Friday, hosted by Every CEO ****[Dan Shipper](https://every.to/@danshipper)****. This week we’ll be away at our quarterly Think Week and republishing some of the best work from our archives in the meantime. We’ll be back with a new piece on Monday, February 2.—[Kate Lee](https://every.to/on-every/kate-lee-joins-every-as-editor-in-chief)*
...
The place to be on Thursday was Vibe Code Camp, our all-day marathon stream featuring 16 vibe coders from Anthropic, Google, Notion, Portola, and, of course, Every—including **[Ben](https://every.to/source-code/the-tool-that-lets-you-switch-models-without-losing-your-place) [Tossell](https://every.to/podcast/how-to-run-a-profitable-one-person-internet-business-using-ai), Ashe Magalhaes, Ryan Carson, Nat Eliason, [Tina He](https://every.to/@fkpxls), Paula Dozsa, CJ Hess, [Logan Kilpatrick](https://every.to/podcast/how-to-make-a-video-game-with-chatgpt-in-60-minutes), Ammaar Reshi, [Geoffrey Litt](https://every.to/podcast/you-can-build-an-app-with-chatgpt-in-60-minutes), Kevin Rose**, and **Thariq Shihipar**.
...
[![A list of the most mentioned tools and companies at Vibe Code Camp. (Image courtesy of Austin Tedesco.)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3909/optimized_40224573-5265-4beb-ba02-c4e153a40c07.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3909/optimized_40224573-5265-4beb-ba02-c4e153a40c07.png)
*A list of the most mentioned tools and companies at Vibe Code Camp. (Image courtesy of Austin Tedesco.)*
...
The overarching theme was that there’s a change happening in where human effort happens. The hard part used to be building. Now it’s knowing what you want AI to build, and which tools and systems will help you get there.—*[Katie Parrott](https://every.to/@katie.parrott12)*
*Watch the stream on [YouTube](https://www.youtube.com/watch?v=5YBjll9XJlw&t=66s).*** **

##

## Knowledge base

**[“I Stopped Reading Code. My Code Reviews Got Better.”](https://every.to/source-code/i-stopped-reading-code-my-code-reviews-got-better)** *by Kieran Klaassen/Source Code*: A simple bug fix touched 27 files and more than 1,000 lines of code. A year ago, **[Cora](https://cora.computer) **general manager **[Kieran Klaassen](https://every.to/@kieran_1355)** would have spent hours reading every line. But recently, he ran a single command that spun up 13 specialized AI reviewers—each trained to catch something different—while he made dinner. Fifteen minutes later, he’d made three decisions and shipped the fix, including catching a critical error. Read this for the full workflow, plus Kieran’s 50/50 rule for making sure fixed bugs stay fixed.
🎧 🖥 **[“Opus 4.5 Changed How Andrew Wilkinson Works and Lives”](https://every.to/podcast/opus-4-5-changed-how-andrew-wilkinson-works-and-lives)** *by Rhea Purohit/AI & I*: These days Tiny cofounder **Andrew Wilkinson** wakes up at 4 a.m. because he can’t wait to keep building with Opus 4.5. In the past few weeks, he tells **[Dan Shipper](https://every.to/@danshipper)** on the latest episode of *AI & I*, he’s built an AI relationship counselor that predicts the fights he’ll have with his girlfriend, a custom email client that cut his inbox load in half, and a personal stylist that texts him outfit recommendations every morning. The kicker: All of this has made him rethink software investing at Tiny, because code is no longer the moat. 🎧 🖥 Listen on [Spotify](https://open.spotify.com/episode/2B6Ezhw33reiT8Vrk2mf1V?si=kxgpPQLyQA6Bt_eFmMkdrw&nd=1&dlsi=bf705e9613dd4b18) or [Apple Podcasts](https://podcasts.apple.com/us/podcast/how-andrew-wilkinson-uses-opus-4-5-in-his-work-and-life/id1719789201?i=1000746113365), or watch on [X](https://x.com/danshipper/status/2014088080093860071) or [YouTube](https://www.youtube.com/watch?v=WDQ-lMvqx90).
**[“What the Team Behind Cursor Knows About the Future of Code”](https://every.to/source-code/what-the-team-behind-cursor-knows-about-the-future-of-code)** *by Katie Parrott/Source Code*: “The IDE is kind of dead,” Cursor’s developer education lead declared at Every’s first Cursor Camp. The center of gravity has shifted from typing code to managing agents that write it for you. Engineer **Samantha Whitmore** shared her workflow and revealed a research project where agents built a working web browser from scratch—3 million lines of code, $80,000 in tokens. Read this for power-user techniques from the people building the tool. *This event was sponsored by Cursor.*
**[“What AI Is Teaching Us About Management”](https://every.to/also-true-for-humans/what-ai-is-teaching-us-about-management)** *by Mike Taylor/Also True for Humans*: Every time you rewrite a prompt because Claude misunderstood you, you’re learning to be a better manager. **[Mike Taylor](https://every.to/@mike_2114)** has found that the techniques for managing people and models are identical: clear direction, enough context, well-defined tasks. The difference is that AI doesn’t hold a grudge when you give unclear instructions, so you can practice without consequences. Read this for the lessons AI teaches us about what your employees need to hear.
...
I’ve followed this tradition for about five years, but the past month of watching Claude Code and [agent-native software](https://every.to/chain-of-thought/agent-native-architectures-how-to-build-apps-after-the-end-of-code) take off has shaken something inside of me. This week, with a little anxiety and a lot of curiosity, I suggested to a group of fellow seekers that we’ll likely create consciousness in machines—and soon.
...
The truth is that I don’t really know if we’ll create consciousness. But I know we can’t refuse to ask the question. I’m going back to the ashram next year, and I suspect this conversation isn’t over.—*[Ashwin Sharma](https://www.glp1digest.com/)*
...
*For sponsorship opportunities, reach out to [[email protected]](https://every.to/cdn-cgi/l/email-protection#2c5f5c43425f435e5f44455c5f6c495a495e55025843).*
