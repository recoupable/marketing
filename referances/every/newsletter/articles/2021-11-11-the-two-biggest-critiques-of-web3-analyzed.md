---
title: "The two biggest critiques of web3, analyzed"
subtitle: "With a little help from Clay Christensen, strategy legend"
author: "Nathan Baschez"
date: 2021-11-11
column: divinations
url: https://every.to/divinations/the-two-biggest-critiques-of-web3-analyzed
paywalled: false
scraped_at: 2026-06-11T16:08:47.827Z
---
...
*New to Divinations? It’s a weekly column on business strategy written by me, *[Nathan Baschez](https://twitter.com/nbashaw)*, co-founder of *[Every](https://every.to)* and former first product/engineer at Substack and Gimlet Media. I use classic theories of business strategy to try and understand what will work (and not work) in technology, media, and web3.*
...
1. Pretty much anything that can be done on a blockchain can be done in web2. Sure, you have to trust a centralized provider, but 99% of the time that’s fine. Society requires trust to function.

2. The main use-case of web3 is speculation and money laundering. We’ve been promised much more, but at this point blockchain technology is over a decade old. It didn’t take web1 nearly this long to flourish after the browser and HTTP were invented. Shouldn’t more have happened by now?
...
The pattern, first described by Clay Christensen in his [massively important](https://every.to/divinations/finding-power-432187) book *The Innovator’s Solution*, goes like this:
...
(In crypto, this ability for components to work together in an open way is called “[composability](https://future.a16z.com/how-composability-unlocks-crypto-and-everything-else/).”)
...
(If you’re interested I wrote a whole post on that [here](https://every.to/divinations/finding-power-432187), but the TL;DR is power belongs to the company who controls the integration between the layers of the value chain that determine performance for the things that matter most to end users.)
...
And all this happened with surprisingly little at stake: in the case of open source the main incentive is just individual software engineers gaining prestige and high-paying jobs. Nadia Eghbal has [written extensively](https://nadiaeghbal.com/oss/) about the incentive problems in the open source community holding back progress.
Now imagine the impact open source could have if people weren’t just incentivized by status or high-paying jobs, but also by value creation via tokens. Actually, you don’t have to imagine it! Vitalik Buterin, the founder of Ethereum, is a billionaire. That’s an extreme example, but web3 has generated life-changing wealth for hundreds of thousands if not millions of people. And maybe all of this is just a speculative frenzy that will go away soon, certainly a lot of it is, but maybe there are some core technologies that are here to stay. Maybe some of the protocols and systems being engineered today will one day feel like HTTP, HTML, Javascript, and all the other open standards that so much of modern society rests upon.
It reminds me of a line I wrote [a couple months ago](https://every.to/divinations/overcoming-web3-bias):
...
If that sounds interesting to you I’d love to hear what you think. [Tweet me](https://twitter.com/nbashaw), [join our Discord](https://every.to/community/join), click one of the feedback buttons below and tell me what I got right and what I got wrong.
