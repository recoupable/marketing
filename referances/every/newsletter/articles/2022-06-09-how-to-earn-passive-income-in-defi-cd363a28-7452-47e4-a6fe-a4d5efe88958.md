---
title: "How to Earn Passive Income in DeFi"
subtitle: "Crypto is one big free money machine, right?"
author: "Nat Eliason"
date: 2022-06-09
column: almanack
url: https://every.to/almanack/how-to-earn-passive-income-in-defi-cd363a28-7452-47e4-a6fe-a4d5efe88958
paywalled: false
scraped_at: 2026-06-11T16:08:37.036Z
---
...
As I explained in “[How are DeFi Yields so High](https://crypto.nateliason.com/p/defi-yields?s=r)?” The sources of yield vary. Some are dividends of profitable crypto businesses. Some are the fees you’re earning for helping provide a service. Others are completely unsustainable free money faucets, the amped-up crypto equivalent of VC-subsidized Uber rides.
...
![](https://substackcdn.com/image/fetch/f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2Fff57b844-f7fc-420f-89fe-4abf0f9e9bce_1600x925.png)

The simplest way to earn yield in DeFi is to supply assets to a borrowing platform like [AAVE](https://aave.com/) or [Compound](https://compound.finance/), and get paid a small amount of interest from the people borrowing that same currency from the platform.
When you deposit assets into AAVE, Compound, [Rari](https://rari.capital/), or other lending protocols, you are then able to borrow other assets against them. Deposit somet ETH, and you can borrow USDC against it.
...
So this is very safe, and requires no maintenance, but the yield is very low. You’ll typically only make 2-4% on stablecoins, and next to nothing on ETH or wBTC. You can also [read more about this strategy here](https://crypto.nateliason.com/p/creating-a-high-yield-savings-account?s=r).

### Trading Fees

### ![](https://substackcdn.com/image/fetch/f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2Fefba0de5-d967-4f02-95e1-284f82473070_1600x1213.png)
...
This is reasonably safe, has minimal maintenance, and has a highly variable yield. Typically the riskier the pair is, the more your yield will be. You can read more about this strategy and [how it works here](https://crypto.nateliason.com/p/decentralized-exchanges?s=r).

### Staking

### ![](https://substackcdn.com/image/fetch/f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2Fb5286c95-7591-4c6e-a404-1070b11ea309_1600x1103.png)
...
For real staking, you have two options. You can set up a validating node yourself depending on what network you want to stake tokens on, or you can just buy liquid staking tokens from a service like Lido. By going to [Lido](http://lido.fi/) you can exchange your ETH for stETH, a token which earns about 4% APR in ETH while sitting in your wallet.
It’s among the safest options, has no maintenance, and has a low but very predictable yield. This doesn’t really require a blog post, you can just check out [Lido](https://lido.fi/), [Rocket Pool](https://rocketpool.net/), or look for other liquid staking solutions if you want to get started.

### Platform Incentives

### ![](https://substackcdn.com/image/fetch/f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2F3bc132f2-c135-47d9-b6f3-2589e1f18ccd_1600x770.png)
...
I mentioned AAVE above, and if you use AAVE on Ethereum you are getting low predictable yield. But if you use AAVE on [Avalanche](https://www.avax.network/), your yields are higher, because Avalanche has given AAVE free AVAX tokens to give away to incentivize people to migrate funds to the Avalanche chain.
...
Platform incentives are where you can get into an insane amount of optimization, earn the highest yields, spend the most time micromanaging it, and also have the highest risk of blowup. If you want more, I have an in-depth guide to [farming with stablecoins](https://crypto.nateliason.com/p/farm-stablecoins?s=r) that covers finding these opportunities. And if you want the super degenerate yield farms that pay out 1,000%+ APR and will probably lose you all your money, you can go shopping on [VFAT](http://vfat.tools/).

### Aggregation

![](https://substackcdn.com/image/fetch/f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2Fa17bc0ed-0bad-40e7-997e-951ce3e7af11_1600x928.png)
...
You can read more about [how they work here](https://crypto.nateliason.com/p/automatic-savings-optimization?s=w), and definitely check out [Yearn](https://yearn.finance/) if you want to try using one. You can also look for good farms to autocompound on [Beefy](http://beefy.finance/).

### Getting Started

![](https://substackcdn.com/image/fetch/f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2F531b33fb-259c-4961-9599-9b8f0c719edd_1600x933.png)
...
2. Send in your ETH from Coinbase to your new Metamask wallet

3. Go to any of the sites linked above (you’ll have the easiest time with the AAVE or Yearn strategies)

4. Deposit your funds

5. Watch your portfolio on [Zapper](https://zapper.fi/)!

And that’s it! You’re earning passive yield. If you want to find more platforms to experiment with, the easiest way is to go to [DefiLlama](https://defillama.com/) and scroll through the top projects on every chain sorted by Total Value Locked. TVL is a decent proxy for legitimacy, since the more money in a project the more battle-tested it is. It’s not perfect, though. Luna had billions in TVL.
