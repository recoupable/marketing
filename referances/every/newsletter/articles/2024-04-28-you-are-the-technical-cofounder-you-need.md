...
subtitle: "Whatever you can’t do, AI can"
author: "Nir Zicherman"
date: 2024-04-28
column: p
url: https://every.to/p/you-are-the-technical-cofounder-you-need
paywalled: false
scraped_at: 2026-06-11T16:08:04.305Z
---

# You Are the Technical Cofounder You Need

*Whatever you can’t do, AI can*

*One of AI’s superpowers is that it expands the definition of who is considered “technical.” As Dan Shipper *[wrote last year](https://every.to/chain-of-thought/you-re-a-developer-now)*, AI makes learning how to code achievable, even if you have no prior knowledge—you just need to know the right prompts. That's why, when aspiring entrepreneurs ask *[Nir Zicherman](https://every.to/@nirzicherman)* (who cofounded podcasting startup Anchor, which was acquired by Spotify) where they can find their technical cofounder, his advice is: Just look in the mirror.* *Read this piece to understand how you can become the technical cofounder you’re looking for. *–[Kate Lee](https://every.to/news/kate-lee-joins-every-as-editor-in-chief)

[Subscribe](https://every.to/subscribe)

---

As an exited founder, I am often approached by aspiring entrepreneurs who believe they have the world’s next great idea. They’re keen to get it off the ground and turn it into more than just a concept.
Usually, we start by talking about the problem they’re hoping to solve. Perhaps I share the advice I commonly give first-time founders: that [most of their assumptions will be wrong](https://www.zaxis.page/p/90-percent-wrong), so it’s key to iterate quickly and [do things that don’t scale](https://www.zaxis.page/p/things-that-dont-scale). Eventually, the conversation turns to something like this:
...
Anchor also began as a big idea: We wanted to make it simple for anyone to create, edit, and share podcasts, at a time when this process was still very costly and limited to a select few. The idea needed real technical execution to get off the ground. We—Mike, myself, and our early team—knew little about audio processing, so we learned on the job. We dreamed of offering live recording and video generation and transcription services; we learned on the job. We’d never built fast and highly reliable systems that served content to users around the world every second of every day; we learned on the job.

[Subscribe](https://every.to/subscribe)

## An ambitious goal is a reason to learn
...
> Relational databases, you say?

> “What is a relational database?”

> Ah, here’s a good YouTube video explaining it in detail. “Help me design my database for my idea.”
...
## Why you’d still want a cofounder
...
***Nir Zicherman**** is a writer and entrepreneur. He was the co-founder of Anchor and the vice president of audiobooks at Spotify. He also writes the free weekly newsletter *[Z-Axis](http://www.zaxis.page/)*.*
