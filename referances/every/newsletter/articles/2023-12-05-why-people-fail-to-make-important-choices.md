...
Meet [Elle](https://www.respell.ai/?utm_source=affiliate&utm_medium=email&utm_campaign=every-newsletter&utm_content=), your AI-powered team member that evolves with your processes and data, integrating seamlessly with Gmail, Notion, Airtable, Salesforce, and more. [Elle's](https://www.respell.ai/?utm_source=affiliate&utm_medium=email&utm_campaign=every-newsletter&utm_content=) genius lies in suggesting, building, and executing workflows tailored to your needs. With the capability to create agents and schedule automations, Elle ensures efficiency and is fully SOC-2 compliant. Try Elle now and experience the future of team collaboration.

[Try it at Respell.ai](https://www.respell.ai/?utm_source=affiliate&utm_medium=email&utm_campaign=every-newsletter&utm_content=)

PS: Use the promo code **PHmagic** to unlock the future of teamwork.

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#582b2837362b372a2b3031282b183d2e3d2a21762c37).
...
This was the case in the first company I built, [Hacker Paradise](http://hackerparadise.org/), a travel community for digital nomads. My cofounder and I took nearly two years to decide whether to treat it as a side project or a business we were trying to grow.
...
In the end, our indecision made the choice for us. Three years into the business, my cofounder and I burnt out. We had built a nice little business, but one that was shaped [more like a restaurant](https://dealbreaker.com/2014/09/peter-thiel-will-not-be-opening-a-south-indian-restaurant-in-silicon-valley) than a startup: we had low margins, and it took a ton of work to run.
...
I’ve observed a similar pattern in friends and [clients](http://nosmallplans.io/). From the outside, the avoidance is obvious, and it’s often clear what choice needs to be made. But for the person making the decision, it can still be agonizingly difficult.
[Acceptance and commitment therapy (ACT)](https://every.to/no-small-plans/how-to-do-hard-things) can help us understand why we get stuck around important choices and how to practice the skill of choosing well. In this piece, we’ll explore the inner barriers to decision-making and how you can unblock yourself to make choices that matter.

####

[Elle by Respell](https://www.respell.ai/?utm_source=affiliate&utm_medium=email&utm_campaign=every-newsletter&utm_content=) isn't just an AI chat agent; it's a revolution in workflow automation. By learning and adapting to your team's unique processes, Elle makes work smoother and smarter. From generating new workflow suggestions to executing them with precision, [Elle](https://www.respell.ai/?utm_source=affiliate&utm_medium=email&utm_campaign=every-newsletter&utm_content=) is the teammate you didn't know you needed. Its integration with your existing tech stack, like Gmail and Salesforce, means you get a unified, powerful tool at your fingertips. And with Elle's full SOC-2 compliance, you can trust in its reliability and security. Don't miss out on the opportunity to elevate your team's productivity.

[Try it at Respell.ai](https://www.respell.ai/?utm_source=affiliate&utm_medium=email&utm_campaign=every-newsletter&utm_content=)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#5d2e2d32332e322f2e35342d2e1d382b382f24732932).
...
In his book, [Staring at the Sun](https://www.amazon.com/Staring-Sun-Overcoming-Terror-Death/dp/0470401818), psychologist Irv Yalom writes that major decisions can bring up existential anxiety. We feel this way because choices are like a mini-death, where we lose a possibility of what our lives and work might become.
...
This fear can occur in founders at all stages. At the early stage, people try to think their way to a “right” answer, when what they really need to do is talk to users and get real-world data. At the later stage, founders may hesitate to risk what they’ve already built for an uncertain future, even if that direction might ultimately be better—the classic [innovator’s dilemma](https://en.wikipedia.org/wiki/The_Innovator%27s_Dilemma).
Kodak is an apt example of this. They were the dominant player in photography for decades, holding a strong position in both film manufacturing and camera sales. Despite [inventing the first digital camera](https://spectrum.ieee.org/first-digital-camera-history#:~:text=Invented%20in%201975%20at%20Eastman,commemorated%20as%20an%20IEEE%20Milestone.), Kodak hesitated to make the shift toward digital.
The company was heavily invested in traditional film, and the transition to digital imaging threatened to cannibalize its core business. Eventually, Kodak lost market share to other companies that embraced digital photography, like Canon and Nikon, and [filed for bankruptcy](https://www.theatlantic.com/business/archive/2012/01/kodak-files-bankruptcy/332934/) in 2012.
...
However, it’s important to distinguish between procrastinating on a decision and intentionally delaying a choice, because waiting on a decision can kill a company. Consider the case of shipping company [Shyp](https://www.crunchbase.com/organization/shyp). An attempted turnaround failed because the founders hesitated on the decision to narrow their focus to business customers.
When the founders finally pulled the trigger on this decision, the company started making real revenue—but it came too late. As cofounder Kevin Gibbons wrote in [his post-mortem](https://www.linkedin.com/pulse/i-cant-wait-you-see-what-we-do-next-kevin-gibbon/) of the business:
...
When this happens, I try to drop out of that chain of thought and get a sense of what it is that I’m avoiding. Whether it’s the fear of making a mistake or a loss associated with the decision, noticing and naming what I’m running from often takes the energy out of the [cycle of avoidance](https://every.to/no-small-plans/how-to-break-the-anxiety-fear-avoidance-cycle).
...
To start, notice simple preferences. For example, do you prefer chocolate or vanilla ice cream? Which parts of your job do you enjoy, and which drain you? Who is your favorite band, and how do you feel when you [listen to Nickelback](https://www.grunge.com/51980/nickelback-became-hated-band-music-industry/)?
If you pay closer attention, you’ll notice that each of your responses above corresponds to a [felt sense](https://www.lesswrong.com/posts/eccTPEonRe4BAvNpD/the-felt-sense-what-why-and-how) in your body of “like” or “dislike.” If you practice this in daily life, you’ll notice that all throughout the day, you’re bombarded with little tastes of pleasant and unpleasant—things you’re pulled toward and away from.
...
*Casey Rosengren is a founder and executive coach based in New York. If you’d like to learn more about coaching, *[drop him a note](https://www.nosmallplans.io/)*.*
