---
title: "Just-In-Time PM #16: Effective ROA"
author: "Tiago Forte"
date: 2018-06-03
column: forte-labs
url: https://every.to/forte-labs/just-in-time-pm-16-effective-roa-539352
paywalled: false
scraped_at: 2026-06-11T16:09:38.782Z
---

# Just-In-Time PM #16: Effective ROA

In [Part 15](https://every.to/praxis/just-in-time-pm-15-multithreading-539347), I advocated for multithreading, or weaving together multiple projects to take advantage of unexpected opportunities and synergies.
...
To accomplish these, we’ll need to refine our understanding of Return on Attention (ROA), first introduced in [Part 1](https://every.to/praxis/just-in-time-project-management-a-538532).
...
With this budget, the constraint is clearly deep focus, and a **constraint unit (CU) would be one hour of deep focus time** (a CU is equivalent to a “flow cycle,” discussed in [Part 3](https://every.to/praxis/just-in-time-pm-3-flow-cycles-538659)).
...
[![](http://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/810/optimized_0c4f7653-a140-45ee-bcb5-23ead0566bdd_900x506.jpeg)](http://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/810/optimized_0c4f7653-a140-45ee-bcb5-23ead0566bdd_900x506.jpeg)

The core of your bandwidth, the deep focus, is the scarcest variety of attention, because it is so difficult and expensive to get into that state of flow (as discussed in detail in [Part 2](https://every.to/praxis/just-in-time-pm-2-the-fundamentals-538543)).
