...
I learned this the hard way in my [first company](http://www.hackerparadise.org/), which became all-consuming. It was a travel company—an operationally intense business with low margins—and we were always six months away from running out of cash. Most of the time, it felt like some aspect of the business was on fire.
...
In the language of behaviorism, we’d say that my life fell under “aversive control.” In other words, I was making decisions driven by [fear of bad outcomes](https://every.to/no-small-plans/five-core-fears-that-drive-ambition), not inspired by the call of something greater. And fear is a lousy foundation for making good choices.
...
B.F. Skinner, the father of [modern behaviorism](https://en.wikipedia.org/wiki/Radical_behaviorism), taught that we act either to move *toward* pleasure or *away* from pain. Everything we do in life comes down to one of these two motivations.
...
“Liberation,” viewed through a behavioral lens, is the ability to orient toward what’s appetitive (i.e., pleasant or meaningful), even in an environment full of aversive stimuli. For me, this has meant learning to stay [connected to a larger vision](https://every.to/no-small-plans/how-to-identify-and-live-your-life-by-your-values) and the joy of creativity, even during difficult times.
...
However, it’s hard to always be fully aware of what’s driving us, so it can be helpful to familiarize yourself with what aversive control feels like on the inside. It shows up a bit differently for everyone, but [there are some commonalities](https://www.apa.org/topics/stress/body).
...
Yet there is pain and difficulty [inherent to life as a founder](https://every.to/no-small-plans/how-to-break-the-anxiety-fear-avoidance-cycle). So in order to find freedom amid discomfort, we have to learn to make space for what’s hard instead of always running from it.
Making space means having the willingness to allow your thoughts, feelings, memories, and urges to be there, without doing anything to try and get rid of them. In essence, you don’t do anything to them, nor do anything because of them. You don’t have to “accept” or “enjoy” them. All you need to do is [stop trying to escape](https://every.to/expanding-awareness/stop-running-from-emotions-and-start-being-more-productive) and instead, allow yourself to experience what’s hard.
...
There was a particularly stressful period at my first startup where we thought we might go bankrupt. A [natural disaster](https://en.wikipedia.org/wiki/2016%E2%80%9317_South_American_floods) had hit Peru right as we were starting a trip there, and we didn’t have enough cash on hand to issue refunds if everyone had demanded their money back.
...
This is the wonderful thing about entrepreneurship: It’s a high-pressure environment for learning how to skillfully relate to stress and difficulty. In many ways, it serves as a crucible for developing as a person. You either [adapt and grow, or you burn out](https://every.to/no-small-plans/a-founder-s-guide-to-expanding-your-comfort-zone).
...
*Casey Rosengren is a founder and *[executive coach](http://nosmallplans.io/)* based in New York. If you’d like to learn more about *[ACT](https://every.to/no-small-plans/how-to-do-hard-things)* and values-oriented coaching, drop him a note.*
