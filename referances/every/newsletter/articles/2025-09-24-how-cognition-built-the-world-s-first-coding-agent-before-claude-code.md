---
title: "🎧 Cognition’s CEO on What Comes After Code"
subtitle: "Scott Wu built the first coding agent. Now he thinks engineers may never write code again."
author: "Rhea Purohit"
date: 2025-09-24
column: podcast
url: https://every.to/podcast/how-cognition-built-the-world-s-first-coding-agent-before-claude-code
paywalled: false
scraped_at: 2026-06-11T16:07:34.014Z
---
...
*TL;DR: Today we’re releasing a new episode of our podcast *[AI & I](https://every.to/podcast)*. ****[Dan Shipper](https://every.to/@danshipper)**** sits down with ****Scott Wu****, the cofounder and CEO of Cognition, maker of the autonomous AI coding agent Devin. ****Watch [on X](https://x.com/danshipper/status/1970916942992003162) or [YouTube](https://youtu.be/ectyyex0IBo), or listen on [Spotify](https://open.spotify.com/episode/0i4B4gi2khE3SRPgK5mr8x) or [Apple Podcasts](https://podcasts.apple.com/us/podcast/cognitions-ceo-on-what-comes-after-code/id1719789201?i=1000728258296). ****Here’s a link to the [episode transcript](https://every.to/podcast/transcript-d605184b-b24e-49e5-878a-372e68ff8cdb).*
*Was this newsletter forwarded to you? [Sign up](https://every.to/account) to get it in your inbox.*

---

The future has a way of showing up early to some places. In [software](https://every.to/c/compounding-engineering) engineering, one of those places is [Cognition](https://cognition.ai/)—the startup that made headlines in early 2024 with [Devin](https://every.to/chain-of-thought/coding-with-devin-my-new-ai-programming-agent), the world’s first autonomous coding agent, and more recently with its [acquisition of the AI code editor Windsurf](https://cognition.ai/blog/windsurf).
**[Scott Wu](https://x.com/scottwu46?lang=en)**, Cognition’s cofounder and CEO, has a front-row seat to what comes next. In this episode of *[AI & I](https://every.to/podcast)*, **Dan Shipper** talks with Wu about why the fundamentals of computer science still matter in an AI-first world, the direction he sees for the short- and long-term future of programming, and why he believes we may already be living with AGI.
You can check out their full conversation here:
[![](https://img.youtube.com/vi/ectyyex0IBo/maxresdefault.jpg)

![](https://d24ovhgu8s7341.cloudfront.net/static/emails/youtube-logo.png)](https://youtu.be/ectyyex0IBo)
...
[Claude Code](https://every.to/vibe-check/vibe-check-claude-3-7-sonnet-and-claude-code)'s arrival marked a turning point in the AI coding space. Practically overnight, many engineers—including the [team at Every](https://every.to/source-code/claude-code-camp)—shifted from tools built into IDEs, the software environments where developers normally write and manage code, to Anthropic’s new CLI-based approach, which lets you interact with your computer by typing commands directly into a terminal.
...
Here’s a link to the [episode transcript](https://every.to/podcast/transcript-d605184b-b24e-49e5-878a-372e68ff8cdb).
...
1.
[Watch on X](https://x.com/danshipper/status/1970916942992003162)

2.
[Watch on YouTube](https://youtu.be/ectyyex0IBo)

3.
[Listen on Spotify](https://open.spotify.com/episode/0i4B4gi2khE3SRPgK5mr8x) (make sure to follow to help us rank!)

4.
[Listen on Apple Podcasts](https://podcasts.apple.com/us/podcast/cognitions-ceo-on-what-comes-after-code/id1719789201?i=1000728258296)
