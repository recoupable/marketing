---
title: "Does Crypto Have Any Good Use Cases?"
subtitle: "Besides making VCs richer, of course"
author: "Nat Eliason"
date: 2022-08-01
column: almanack
url: https://every.to/almanack/does-crypto-have-any-good-use-cases
paywalled: false
scraped_at: 2026-06-11T16:08:34.218Z
---
...
Yes, you can’t use your stablecoins to buy much in the real world (unless you use a [Juno](https://onjuno.com/)debit card). And yes, you still need to convert it into local money in most places, and that might be expensive.
...
Right now, you can only use other cryptos as collateral, but we’re still in the early days. Lightsabers and beer pouring. MakerDAO is already working on [bringing real-world assets](https://blockworks.co/makerdao-adopts-real-world-assets-as-crypto-leverage-demand-wanes/)on-chain as collateral. Multiple projects are creating on-chain versions of public company stocks. As more assets get moved or mirrored on-chain, the number of things you’ll be able to leverage will expand significantly.
...
1. Could not be done without blockchain tech

2. Would be much shittier without blockchain tech (akin to Postmates on a phone vs. IBM mainframe)

Here’s a hodgepodge, feel free to toss any other ideas in the comments.

### Cashing Out Value Locked in Various Silos

Video games are one form of this, and I’ve written about crypto gaming extensively ([and critically](https://crypto.nateliason.com/p/fix-crypto-gaming)). But any digital economy or ecosystem with a form of internal value could use crypto to make that value extractable to other currencies. This is one area where [decentralized exchanges](https://crypto.nateliason.com/p/decentralized-exchanges) with permissionless token listings are particularly powerful.
...
With the digital currency innovation, companies can start taking digital payments without fees. Considering many businesses margins are less than 10%, getting back 2-4% of each purchase is massive. [Solana Pay](https://solanapay.com/) is already offering this and there will likely be many more tools for it in the future.
