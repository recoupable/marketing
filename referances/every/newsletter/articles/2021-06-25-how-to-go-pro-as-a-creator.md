---
title: "How to Go Pro as a Creator"
subtitle: "John Gannon from GoingVC shares how he made $1mm in revenue as a creator"
author: "John Gannon"
date: 2021-06-25
column: superorganizers
url: https://every.to/superorganizers/how-to-go-pro-as-a-creator
paywalled: false
scraped_at: 2026-06-11T16:08:56.893Z
---
...
Back in 2008, I started [a blog about how to break into VC](http://johngannonblog.com/vc-careers). I knew how hard it was to break into the industry and I wanted to give back. I had no idea that that blog would turn into an email list ~20,000 subscribers strong. That list led me to launch a [cohort-based education](https://www.weskao.com/blog/super-specific-how) program (we’re on our eighth cohort!) and community, [GoingVC](http://goingvc.com/), as well as a related VC investment arm.
All in all, the programs, products, services, and companies I’ve created or co-founded have grossed over $1MM lifetime revenue. Yet when I started my journey as a creator, the thought of how I would monetize my work never even crossed my mind. Plugging away week after week after week, newsletter after newsletter, [project](http://johngannonblog.com/venture-capital-salary-survey) after [project](https://www.amazon.com/Finding-Startup-Jobs-getting-startup-ebook/dp/B00W4HPEUI), I was unwittingly playing the long game, well before I even knew [what the long game was](https://fs.blog/2018/10/long-game/). Maybe not knowing exactly what it would all come to is how I ended up a 10+ year “overnight” success—a creator who’s built a platform that’s begun to look more like a business than a blog, and throws off enough income so that I can spend more time... creating.
...
Don’t worry, though. If the thought of writing an article makes your skin crawl, or just feels like too much work, there are so many other mediums you can use to build an audience as a creator. Jonathan Lehr and Matt Turck built their brands in the VC world by creating meet-ups ([New York Enterprise Tech Meetup](https://medium.com/work-bench/reflecting-on-6-years-of-organizing-the-ny-enterprise-tech-meetup-nyetm-53835c491379) and [Data Driven](https://firstmarkcap.com/events/data-driven/)), and superconnector Laurel Touby took a similar approach with her Cereal Entrepreneurs Breakfast. Jason Gaignard built his network through his [Mastermind Dinners](https://jamesclear.com/book-summaries/mastermind-dinners), and [Jenny Gyllander used Instagram](https://medium.com/@gyllanderjenny/thingtester-by-day-3b58f2e824db) to build a following [which has transformed into a VC backed startup](https://nordic9.com/news/thingtesting-announced-raising-2-million-from-investors-led-by-forerunner-ventures/).
...
A related pitfall is focusing on automation too early. If you’re doing anything content related, you can go a long way with tools like [Zapier](http://zapier.com/) and with virtual assistants or people you hire straight from your audience. To this day, I still have someone helping me out part-time who manually follows a process to find and then [post VC jobs to my blog](http://johngannonblog.com/vc-careers). I hope that shows you that you don’t need to hire a developer to build some automated machine learning thingy to post content for you, when maybe paying someone $20/hour to post stuff by hand would get you launched today (versus six months from now).

## Pro Mode

### Step 3: Go pro as soon as possible

One thing I didn’t realize until many years into my journey is how important it is to “go pro” before you think you’re ready. My definition of what it means to go pro comes straight from Steve Pressfield, in his book [The War of Art](https://www.amazon.com/dp/B007A4SDCG/). In fact, he devoted a whole chapter to this critical topic.
...
I never was grinding away seven days a week on ‘creation.’ Hard to do when you are [trying to have a work-life balance](https://bijansabet.com/2012/04/09/i-feel-guilty-when-my-son-says-mommy-put-down/). But what I did do—like a pro would—was hire someone to help me out part-time with posting jobs to the blog. Doing that meant that *someone* was doing something to move the project forward every single day.
...
[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1740/optimized_kC33Pk5apNbT3PvtTXa5-3iQ1Jo6A3NteOgnyiRFf42fnu-KaqlETcj5li5UzWb5WorAF971VFbpp41YnEt2MRghfNBtbA31lar1Nhmq1vxGQZ_WR0xAWpDhh9ahxpHVKF0hhcfI.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1740/optimized_kC33Pk5apNbT3PvtTXa5-3iQ1Jo6A3NteOgnyiRFf42fnu-KaqlETcj5li5UzWb5WorAF971VFbpp41YnEt2MRghfNBtbA31lar1Nhmq1vxGQZ_WR0xAWpDhh9ahxpHVKF0hhcfI.png?link=true)
...
You might be thinking that hiring someone is going to take a ton of your time. It could. But there’s a better way. Here’s my process at a high level, *which allows me to only have to interview a single person for any position* for which I’m hiring, whether I get 10 applicants or 100. This process was inspired by the book [Code as Cards](https://www.amazon.com/Ship-While-You-Sleep-Software-ebook/dp/B01CX7EKGW):

1. Email the opportunity to my audience

2. People apply

3. A small number of applicants are selected to a complete a series of tasks relevant to the job (for pay)

4. I interview the person who completes the tasks the best on time

5. If the interview goes well I hire them to a two week trial period

6. If that works, we continue!
...
[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1740/optimized_PcgxUUpqMAr6DxFFQ9RLitopDUbZdjQwmN9QwnRMb-UmQXfFSNCD8H5h9mX0EoHXZh1js0jxWdsN2IEqHVH5WIfzzd5ZASMVMxpTAADznrMv7dwryUggHD1X8C2JCiIVuKp4uhIi.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1740/optimized_PcgxUUpqMAr6DxFFQ9RLitopDUbZdjQwmN9QwnRMb-UmQXfFSNCD8H5h9mX0EoHXZh1js0jxWdsN2IEqHVH5WIfzzd5ZASMVMxpTAADznrMv7dwryUggHD1X8C2JCiIVuKp4uhIi.png?link=true)

I think most brands and creators would kill for a [CPA](https://en.wikipedia.org/wiki/Cost_per_action) like that (less than 40 cents per subscriber). Heck, I’d kill for a CPA like that right now ;) Which goes to show that had I started investing in paid ads earlier, my email list and platform would be that much bigger today.
...
1. Are people writing you, unsolicited, and telling you what I’m putting out—be it emails, events, Insta, whatever—is great?

2. Are you doing whatever it is you are doing on the regular? Are those dinners you’re running happening monthly? Are those blog posts going out weekly? Is that Substack hitting people’s inboxes twice a month?

3. Do you have a way to make sure you don’t lose touch with the people you’re engaging? Do you have a place (Twitter, email subscription form, a Discord server, etc.) to send them once they’re engaged, so that you can keep engaging with them?
...
No, I’m not suggesting you launch a [SPAC](https://www.pwc.com/us/en/services/audit-assurance/accounting-advisory/spac-merger.html). I’m suggesting you go out and acquire assets, and use them to help scale your platform as a creator. This is *not* a call to cash in your 401k to go out and buy a small business.
What I am saying is that there’s a whole world of “mini M&A” opportunities out there—companies, projects, products—that can be bought for as little as four or five figures. And even better, you can structure these deals so that you’re not paying 100% of the purchase price up front. Heck, you can even hack this so that[you’re not paying a penny out of your own pocket](https://every.to/superorganizers/how-i-bought-a-business-for-0).
...
- I went back to the ranch to pressure test my assumptions around the deal with our team. I wrote up a 1-pager ([using a variant of my favorite 1-pager template](https://www.atlassian.com/software/confluence/templates/project-poster)) to communicate the opportunity and my thoughts about it -- including things like deal structure, price, and terms.
...
[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1740/optimized_IkjzwLMAcbXy4G_js6BXYE1vIKvy9WVycFH7vvxXX1KhNkVRpW61oAoC8GRhQTGY6Umafr4GEHARm-WL5WOPnFBo6ZGpsCyiZsTveaANv1ijtj2rJfcrVssbcXdz-QV_59awpcbU.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1740/optimized_IkjzwLMAcbXy4G_js6BXYE1vIKvy9WVycFH7vvxXX1KhNkVRpW61oAoC8GRhQTGY6Umafr4GEHARm-WL5WOPnFBo6ZGpsCyiZsTveaANv1ijtj2rJfcrVssbcXdz-QV_59awpcbU.png?link=true)
I’m excited to do more “mini M&A” like what we did with [Negotiating the Terms](https://www.negotiatingtheterms.com/blog). And now that you have a playbook for it, I don’t see why this strategy can’t work for you to add a website, a book, a Twitter account, or a podcast, to your growing creator platform.

## Summing Up

If after looking at all of this it still feels unjustified to hire people to help you build your platform faster, or to buy ads, or to do mini M&A then there’s a simple exercise I’d propose to help you figure out how to get over the hump. The question is from [E-Myth Revisited](https://www.amazon.com/dp/B000RO9VJK):
...
I’d love to know what’s worked for you—and what hasn’t—to get you to where you are right now. Since the best way to learn is by learning from each other, ping me on Twitter ([@johnmgannon](http://twitter.com/johnmgannon), DMs are open). Let’s continue the conversation there, so we all can learn together.
