---
title: "Apple Embraces the Enemy"
subtitle: "What its unlikely AI alliance with OpenAI and Microsoft means"
author: "Dan Shipper"
date: 2024-06-12
column: chain-of-thought
url: https://every.to/chain-of-thought/apple-embraces-the-enemy
paywalled: true
scraped_at: 2026-06-11T16:08:02.702Z
---
...
Paul Graham famously remarked about OpenAI CEO [Sam Altman’s dealmaking](https://paulgraham.com/fundraising.html), “You could parachute him into an island full of cannibals and come back in five years and he'd be the king.”
...
It’s an interesting pattern—local on-device AI with cloud fallback—that both [Microsoft](https://every.to/chain-of-thought/gpt-5-is-coming-reading-between-the-lines-at-microsoft-build?sid=48705) and Apple have adopted. Yes, both companies are integrating OpenAI technology in various ways. Microsoft’s [integration is very deep](https://every.to/napkin-math/microsoft-s-boring-but-profitable-future?sid=48706), while Apple outsources the queries it doesn’t have confidence it can correctly answer to ChatGPT (happily outsourcing that risk to OpenAI).
...
On the one hand, this was fairly predictable. In December 2022, I [wrote](https://every.to/chain-of-thought/i-trained-a-gpt-3-chatbot-on-every-episode-of-my-favorite-podcast?sid=48559) that power would collect in four layers in the AI ecosystem:
