---
title: "Figma’s Layered Lessons"
subtitle: "Or, how to learn something useful from big events"
author: "Nathan Baschez"
date: 2022-09-20
column: divinations
url: https://every.to/divinations/figma-s-layered-lessons
paywalled: false
scraped_at: 2026-06-11T16:08:31.790Z
---
...
This essay is brought to you by[Maven.com](https://maven.com/?utm_source=paid_email&utm_medium=email&utm_campaign=mp22_every_newsletter), the home of career-building cohort-based courses that help ambitious professionals level up, get promoted, and build new skills.

[Browse Courses](https://maven.com/?utm_source=paid_email&utm_medium=email&utm_campaign=mp22_every_newsletter)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#e794978889948895948f8e9794a7829182959ec99388).
...
[Maven’s](https://maven.com/jackie-bavaro/cracking-the-product-strategy?utm_source=paid_email&utm_medium=email&utm_campaign=mp22_every_newsletter) 1-week course,[Cracking the Product Strategy](https://maven.com/jackie-bavaro/cracking-the-product-strategy?utm_source=paid_email&utm_medium=email&utm_campaign=mp22_every_newsletter) will teach you how to build a winning strategy for your product by focusing on what matters most to drive growth.
...
[Learn from Jackie](https://maven.com/jackie-bavaro/cracking-the-product-strategy?utm_source=paid_email&utm_medium=email&utm_campaign=mp22_every_newsletter)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#2152514e4f524e5352494851526144574453580f554e).

But here’s how CEO Dylan Field [described](https://distributed.blog/2021/11/18/dylan-field-figma-talks-design-with-connie-yang/) the origins of Figma as we know it:
“We thought of [Figma] as interface design plus other things. And it wasn’t clear what those other things were. [So we] had a nice whiteboard session with the team where we just crossed all these things off. It’s like, what do we all think we’re doing? Okay, let’s cross them off one by one until we get to what we’re actually doing. And we used a cool framework, “[eliminate, reduce, raise, create](https://www.blueoceanstrategy.com/tools/errc-grid/)” from this book *Blue Ocean Strategy* to figure out what we are doing that’s different than the competition. What are we *not* doing that the competition *is* doing? What are we doing worse? And where are we going to make this brand new?”
...
[![](https://pbs.twimg.com/profile_images/1570226125791428608/aYjwPMd7_normal.jpg)
eigenrobot@eigenrobot

everything 👏 is 👏 monocausal 👏 and 👏 specifically 👏 results 👏 from 👏 whatever 👏 shit 👏 I'm 👏 on 👏 about 👏 at 👏 any 👏 given 👏 time

February 23rd 2018, 2:12pm EST

1k Retweets6k Likes](https://twitter.com/eigenrobot/status/967114911401652225)
...
- Ben Thompson over at Stratechery [argued](https://stratechery.com/2022/adobe-acquires-figma-figmas-disruption-the-figma-os/) that Adobe *had* to buy Figma, because Figma is poised to be the new OS for design, reducing Photoshop and Illustrator to mere plugins.

- Benedict Evans wrote (in his paywalled [newsletter](https://www.ben-evans.com/)) that in addition to being a classic example of disruption theory, Figma also can be understood as unbundling the Adobe suite of creative applications in order to focus just on UX design, while building a new bundle around UX design + team collaboration and communication.

- Karri Saarinen, CEO of Linear, [tweeted](https://twitter.com/karrisaarinen/status/1572353519205888001) a thread saying finance people don’t realize just how separate the market is for Figma and Photoshop / Illustrator. It’s true that people once designed websites and apps in Photoshop, but that was a long time ago. So maybe not such a “textbook” case of disruption?

- Byrne Hobart from The Diff [framed](https://www.thediff.co/p/adobe-covered-its-figma-short-position) Adobe’s acquisition of Figma as “covering a short position.” In other words, the price of *not* acquiring Figma keeps going up as Figma continues to eat at their business, so eventually they get squeezed into buying, so that they can preserve their current $11.3 billion ARR business.

- Hunter Walk, GP at Homebrew, agreed, [arguing](https://hunterwalk.com/2022/09/19/why-figma-is-worth-20b-and-other-observations-from-the-adobe-acquisition/) Adobe calculated the price by asking, “What percent of our market cap do we need to spend to protect the rest of it?”

- Amal Dorai, founder of a startup acquired by Microsoft to build cloud collaboration in Word, [tweeted](https://twitter.com/amaldorai/status/1570516169848918017) a detailed thread about all the difficulties companies can run into when moving from a file-based legacy paradigm to a centralized internet database.

- Mike Davidson, former exec at Figma competitor InVision, [wrote](https://mikeindustries.com/blog/archive/2022/09/adobe-figma-performance-is-the-moat) a post titled “Performance is the Moat” and argued the reason Adobe had to buy Figma instead of building a competitor is that it’s just really frickin hard to build a fast, reliable design tool that runs in the browser.

- Nathan Manousos agreed and [put](https://twitter.com/trafnar/status/1570881763626602499) a finer point on it: “Figma acquisition shows how hard it is to turn money into software. You'd think for $20B you could build something as good as Figma yourself, but you can't. Software is art.”

- Anna Mészáros [tweeted](https://twitter.com/4erepawko/status/1570436634419789826) that designers are right to be worried, because Adobe has a history of jacking up prices, and if they do so would have a huge negative impact on a lot of people all over the world who rely on Figma.
