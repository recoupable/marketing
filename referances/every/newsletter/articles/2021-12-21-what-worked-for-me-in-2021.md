---
title: "What Worked for Me in 2021"
author: "Dan Shipper"
date: 2021-12-21
column: superorganizers
url: https://every.to/superorganizers/what-worked-for-me-in-2021
paywalled: false
scraped_at: 2026-06-11T16:08:45.885Z
---
...
Today’s newsletter is brought to you by [Axios HQ](https://www.axioshq.com/sample-update-saas?utm_campaign=paid-media-placements-dec&utm_source=superorganizers&utm_medium=sponsor&utm_content=nl-sample), **intuitive software from Axios that helps your team think more clearly, communicate more crisply, and send focused, effective updates.**
...
[Improve your writing with Axios HQ](https://www.axioshq.com/sample-update-saas?utm_campaign=paid-media-placements-dec&utm_source=superorganizers&utm_medium=sponsor&utm_content=nl-sample)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#3546455a5b465a47465d5c454675504350474c1b415a).
...
The following is a non-exhaustive list of the things that have [worked](https://every.to/c/productivity) best for me in 2021. I hope it helps.

### No Meetings Before Noon

I’ve been trying to avoid [meetings](https://every.to/c/meetings) before noon so I can get work done, and so far I’ve been pretty good at it this year. Instead, I try to spend my mornings on deep work: writing, editing, thinking about what’s going on at [Every](http://every.to/). It really helps my output and my quality of life. Recommend if possible.

### Streaks

Right now, I’m on a [Streaks](https://streaksapp.com) streak. And it’s great. It’s a little app that’s been around for forever that helps keep track of how many days in a row you do something. I’ve gone back and forth on using it over the years, and right now I’m really enjoying it.

[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1966/optimized_eWCAkJ8Zy4jXwNmO5CItz2ScFhTZpIq-Z6Ly340NTC2GOdFA8z3cgkVSHfbCx9ioYpca79NIHytrqfHf6sPyBb6k6Sps1hRA-OgxHorzgoxg3A8wG4fKwKyJEgunnybRA6zr8XnH.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1966/optimized_eWCAkJ8Zy4jXwNmO5CItz2ScFhTZpIq-Z6Ly340NTC2GOdFA8z3cgkVSHfbCx9ioYpca79NIHytrqfHf6sPyBb6k6Sps1hRA-OgxHorzgoxg3A8wG4fKwKyJEgunnybRA6zr8XnH.png?link=true)

The main things I track are [meditation](https://every.to/c/meditation) (every day), stretching (4x a week), exercise (3x a week), morning pages (5x a week), and exposure (3x a week). (Exposure is treatment for my OCD symptoms, I’ll address more below.)
...
I tried out [Levels](https://www.levelshealth.com), a continuous glucose monitor company, and learned a lot (review coming soon.) It sparked an interest in trying to eat lower carb during the day to see how it affected my energy levels. Anecdotally, it’s *really* effective for me.
...
I got one of those bright lamps that mimic the sun for [$30 on Amazon](https://www.amazon.com/Therapy-Adjustable-Brightness-Function-Rotatable/dp/B08HV89TVQ/ref=sr_1_5?crid=1HHE53NO9ANYI&keywords=sun+lamp&qid=1640188741&sprefix=sun+lemo%2Caps%2C50&sr=8-5). I try to get outside in the morning too, but the lamp seems like it really helps me with that *yuck* feeling I get on cloudy winter days where it’s just a little harder to get out of bed. Definitely worth a shot.
...
I’m perpetually in a [productivity cycle](https://every.to/superorganizers/productivity-cycles-294288) with my [inbox](https://every.to/c/email-management). I’m on top of it for a few weeks, then I get busy and fall off, then I avoid my inbox and it gets worse, and then I buckle down and power through everything in a coffee-induced Sunday fugue state and the cycle starts all over again.
...
I started to think about where I could find such a person, but searching for “email personal trainer” doesn’t yield much. I considered posting on Craigslist and seeing what might come in. Then I realized I might be able to use my virtual assistant. I already shared a part-time VA with [Nathan](https://www.twitter.com/nbashaw), and so I asked if she might help me get my inbox done by providing me with some social accountability. I wasn’t sure if she’d say yes, but she did!
...
You can listen to the ones I listen to [here](https://mindfulcompassion.com/meditations/). I most frequently use #16, Compassionate Self-Visualization.

### ACT

Last January I discovered Acceptance and Commitment [therapy](https://every.to/c/therapy) and it really struck me. The ACT model goes something like this:
...
If you want to read more here are a few [recommendations](https://every.to/c/book-recommendations):
**Dip your toe in:** [A Liberated Mind](https://www.amazon.com/Liberated-Mind-Pivot-Toward-Matters/dp/073521400X)
**Jump into the pool:** [Experiencing ACT From the Inside Out](https://www.amazon.com/Experiencing-Inside-Self-Practice-Self-Reflection-Psychotherapists/dp/1462540643) (This is for clinicians which I generally prefer because they’re more realistic.)
**The deep end:** [Mastering the Clinical Conversation](https://www.amazon.com/Mastering-Clinical-Conversation-Language-Intervention/dp/1462523064)
...
If you’re interested in how and why it might work, I recommend [this episode](https://open.spotify.com/episode/0I1kiY8IbFrl36WQjjeGek?si=c60801b7abae4662) from the Huberman Lab podcast.
...
- [Thread the needle](https://classpass.com/movements/thread-the-needle-pose)

- [Cat to camel](https://physiohealth.com.au/exercises/cat-camel-exercise/)

- [Downward dog](https://www.masterclass.com/articles/downward-dog-explained)

- [Pigeons](https://www.verywellfit.com/pigeon-pose-eka-pada-rajakapotasana-3567103)

- [Kneeling hip flexor stretch](https://evofitness.ch/hip-flexor-stretch/)

I also mix in other stretches depending on the day.

### Inositol

I randomly [came across inositol on Examine.com](https://examine.com/supplements/inositol/) and it’s really helped me with anxiety and OCD symptoms. There’s a reasonable evidence base for it, but** please do not take this** (or any other supplement) without talking to a doctor beforehand. I talked to a doctor and it turned out it was the right thing for me. I’m not a doctor and I’m not making any recommendations, I’m just telling you what seems to have helped.

### Fish Oil

I started taking at least 1000mg of EPA via fish oil [on the advice of the Huberman Lab](https://hubermanlab.com/how-foods-and-nutrients-control-our-moods/) podcast. It’s a little hard to tell if it’s working but [the evidence](https://examine.com/supplements/fish-oil/) says it’s probably helpful for mood support. I’ll keep taking it!
...
When someone expresses a negative [emotion](https://every.to/c/managing-emotions) about me that I feel is unfair my first reaction is often to close off or tamp down. One way I do this is to try to measure how “reasonable” or “fair” the emotion is. I’ll usually admit to whatever I think is “reasonable” and then say, “but”, and try to push away whatever part of the emotion is unreasonable.
...
One way that’s helped me is the idea of “remorse of conscience.” It’s basically [feeling](https://every.to/c/empathy) sad that someone is hurt and that I may have contributed to it without also directing self-condemnation and blame at myself for doing so. It’s empathic guilt.
...
Here’s another thing I learned in couple’s therapy. Business [partnerships](https://every.to/c/managing-people) are hard. If both people are motivated and opinionated, you each end up trying to control each other in contexts that are inappropriate.
