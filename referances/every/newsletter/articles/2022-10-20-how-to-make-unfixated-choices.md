---
title: "How to Make Unfixated Choices"
subtitle: "Exploring the space between stimulus and response"
author: "Michael Ashcroft"
date: 2022-10-20
column: expanding-awareness
url: https://every.to/expanding-awareness/how-to-make-unfixated-choices
paywalled: false
scraped_at: 2026-06-11T16:08:30.556Z
---
...
Hit your health goals faster with [InsideTracker’s](https://info.insidetracker.com/every) personalized performance platform. With a couple of simple at-home tests, InsideTracker pinpoints the biomarkers you can optimize to hit peak performance.

[Save 20% Now](https://info.insidetracker.com/every)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#a3d0d3cccdd0ccd1d0cbcad3d0e3c6d5c6d1da8dd7cc).

Several years ago I somewhat lost my composure during a meeting at work. My manager had called me out for something in front of the team, but without talking to me about it first. I had no idea it was coming and felt attacked, triggered even, and had to navigate wanting to address it in a direct, but professional way.
...
The way to do this is made clear in that well-known quote that’s usually, [but incorrectly](https://quoteinvestigator.com/2018/02/18/response/), attributed to Viktor Frankl:
...
Hey! Dan Shipper here,

When [InsideTracker’s](https://info.insidetracker.com/every) blood test told me I’m 35.4 years old on the inside—even though I’m only 31—I was alarmed. I work out daily. I have a trainer. What else should I be doing?

Fortunately, [InsideTracker](https://info.insidetracker.com/every) had science-backed recommendations. Its health dashboard not only pointed out the biomarkers I need to improve—it gave me a personalized plan to optimize them. Now I know the specific diet and exercise changes I can make to reduce my cholesterol, inflammation, and glucose levels. And the majority are way simpler than I imagined.

[InsideTracker](https://info.insidetracker.com/every) showed me more about my health (and how to optimize it) than a lifetime of annual physicals. Find out what it could show you and save 20% now.

[Get 20% Off InsideTracker](#target)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#0d7e7d62637e627f7e65647d7e4d687b687f74237962).
...
Another way is to learn to notice what’s happening with your broad awareness of the space around you. I’ve written before [about the idea that awareness](https://every.to/expanding-awareness/you-can-only-respond-to-what-you-notice)—the breadth of things you are able to notice in any given moment—can expand and collapse. Collapsed awareness is like tunnel vision, where there’s a sense that the wider world around you goes away while the thing you’re paying attention to seems somehow larger and more salient.
...
*If you want to dig deeper into making unfixated choices, I teach an affordable self-paced online course on Alexander Technique, from which this skill derives (we call it ‘inhibition’). It’s *[here if you’d like to check it out](https://every--michaelashcroft.thrivecart.com/fundamentals-of-alexander-technique/)*. You can also ask me questions *[on Twitter](https://twitter.com/m_ashcroft)*.*
*That’s an affiliate link for Every, by the way, and if you’d rather not click that then *[here’s a non-affiliate link](https://expandingawareness.org/courses/)*.*
