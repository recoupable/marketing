---
title: "Everything OpenAI Launched at DevDay"
subtitle: "A real-time API, prompt caching, higher rate limits, model distillation tools, and more"
author: "Dan Shipper"
date: 2024-10-01
column: chain-of-thought
url: https://every.to/chain-of-thought/everything-openai-launched-at-devday
paywalled: true
scraped_at: 2026-06-11T16:07:56.988Z
---
...
I’m at [OpenAI’s](https://every.to/c/ai-frontiers) developer conference, DevDay, today in San Francisco. Here’s what I saw.

The big news is that the company launched a Realtime API that promises to allow anyone to build functionality similar to [ChatGPT’s Advanced Voice Mode](https://every.to/chain-of-thought/review-chatgpt-s-new-advanced-voice-mode) within their own app. Paired with their new model o1, released a few weeks ago, OpenAI is creating an new way to build software.
...
- An **increase** **of the API rate limits** on the [o1 model](https://every.to/chain-of-thought/openai-s-o1-model-explained) equal to that of GPT-4o (10,000 requests per minute)
...
At the beginning of the AI wave there was a lot of talk about what [artificial general intelligence](https://every.to/napkin-math/the-agi-in-2027-thesis) would look like: Would it be one model to rule them all—GPT-5 for all comers—or would there be different models for different purposes? Today OpenAI told developers that they would be investing heavily in both next-generation GPT-4o and o1-type models. The company is betting on a diversity of models for different use cases as the way forward.
