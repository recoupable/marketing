---
title: "We Tried OpenAI’s New Deep Research—Here’s What We Found"
subtitle: "Vibe check: It’s awesome. "
author: "Dan Shipper, Alex Duffy"
date: 2025-02-03
column: vibe-check
url: https://every.to/vibe-check/we-tried-openai-s-new-deep-research-here-s-what-we-found
paywalled: true
scraped_at: 2026-06-11T16:07:49.945Z
---
...
On Sunday night, OpenAI dropped a new tool called “deep research”—an [agentic](https://every.to/napkin-math/who-wins-the-ai-agent-battle) research assistant.
...
It works much like Google’s product of the same name [released a couple months ago](https://every.to/context-window/how-to-win-at-ai-and-influence-people), but unlike Google’s version, we think deep research is pretty awesome.
...
[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3448/optimized_1.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3448/optimized_1.png)

*Source: *[Chatgpt.com](http://chatgpt.com/).
...
Next we asked it to read the first chapter of *War and Peace*, note the way that Tolstoy uses descriptions to tell us about the inner lives of his characters, and deduce what that says about his view of human nature. It significantly outperformed [Operator’s attempt](https://every.to/chain-of-thought/we-tried-openai-s-new-agent-here-s-what-we-found).
...
[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3448/optimized_3.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3448/optimized_3.png)

*Source: Numbers via ChatGPT.*

Deep research provides citations for the claims it makes and links back to the sources it uses.

[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3448/optimized_4.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/3448/optimized_4.png)

*Source: *[ChatGPT.com](http://chatgpt.com/)*.*

So it’s generally reliable, but it isn’t immune to hallucination. There’s a tradeoff: Deep research can accomplish orders of magnitude more than a typical GPT-4 request, but it requires more time, more trust from the user, and a watchful eye for when it might go off the rails. We assume that we’ll develop this over time, but there is definitely a nagging feeling that some claims presented in the deep research reports just might not be true..
...
In early 2023, I (Dan) [predicted](https://every.to/chain-of-thought/the-end-of-organizing) that AI would soon be able to autonomously write research reports about any topic you wanted. To be honest, I didn’t think it would take this long, but I am *so *glad that that time is finally here.

One of the things we love most about this era of AI tools, like ChatGPT and Claude, is that it ushers in a world where [any question can be answered](https://every.to/chain-of-thought/llms-turn-every-question-into-an-answer) in seconds. Because it’s so easy to ask questions, we find ourselves asking many more of them—and therefore learning much more in a day than we did previously.
