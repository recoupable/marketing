---
title: "The Market Wedge: How to Pick Your Initial Market"
subtitle: "How and why early-stage startups sacrifice growth for power"
author: "Nathan Baschez, Eric Thompson"
date: 2021-09-29
column: divinations
url: https://every.to/divinations/the-market-wedge-how-to-pick-your-initial-market
paywalled: false
scraped_at: 2026-06-11T16:08:50.758Z
---
...
Although startups have been using market wedge strategies since the beginning of time, the term “wedge” was first made popular by Chris Dixon’s article “[The ‘thin edge of the wedge’ strategy](https://cdixon.org/2010/12/26/the-thin-edge-of-the-wedge-strategy).” As a whole, wedges are under-theorized, underutilized, and yet are vital for startup founders to understand.
A wedge is a method for spending limited resources strategically. You pick one thing, do it well, then use that momentum to expand later. [In our first post on wedges](https://every.to/divinations/product-wedges-a-complete-guide), we focus on “product wedges,” where you make your initial product as easy to adopt as possible—even to the point where you sacrifice profitability and defensibility. A good example is TikTok, which got its initial traction in part by allowing users to add music to videos and export them to share with their friends elsewhere (come for the tool), and later developed staying power by focusing on the “For You” page experience (stay for the network).
...
Two years later, Uber had [only expanded to five other markets](https://en.wikipedia.org/wiki/Timeline_of_Uber): New York, Chicago, Paris, Toronto, and London. Two years after that, Uber was in over 100 cities well on its way to becoming the behemoth it is today.
...
1. List the main types of market wedges (geography, topic, product category, community, demographic) with a few good examples for each—and some counter-examples.

2. Explain the key mechanics that make market wedges work.

3. Explore what makes a good initial niche to choose.
...
-
**Opendoor**, a home-buying startup, [launched](https://www.opendoor.com/w/blog/the-past-present-and-future) in Phoenix in 2014, then expanded to Dallas in 2015, and now is available in 44 markets in the US. By concentrating their resources on just one market to start, Opendoor was able to more easily educate potential home sellers and build local brand power and economies of scale.

-
**Uber** started in San Francisco, focusing on making the experience as seamless as possible for a group that was more likely to buy into their new idea. Once established in that market, they expanded to other cities like New York, Paris, and Toronto. They added cities steadily until they reached [100 total cities in 2014](https://www.uber.com/newsroom/history/), four years after their initial limited launch.

-
**Doordash** started in Palo Alto, delivering to Stanford students. This allowed them to work out the kinks in their process (they began as Palo Alto Delivery and took [actual phone calls to place orders](https://medium.com/@DoorDash/the-doordash-story-b370c2bb1e5f)) and expanded once they had the funding and means to do so.
...
-
**The Athletic **is a subscription-based sports publication (no ads) that covers local sports in 47 cities. But they got their start by covering [only Chicago sports teams.](https://en.wikipedia.org/wiki/The_Athletic) Once they built up a supply of great, local sports journalism and a rabid fan community of their own, they started expanding to other cities starting with [Toronto](https://twitter.com/mirtle/status/801452582602424321) and [Cleveland](https://www.crainscleveland.com/article/20170217/BLOGS06/170219821/the-athletic-soon-will-launch-a-cleveland-site-featuring-jason-lloyd).

-
**Twitch** started as the live streaming platform JustinTV. To grow, [they decided to pivot to streaming games](https://www.youtube.com/watch?v=qR0yFSpcXrc) and renamed themselves Twitch. They believed in this singular focus so much that they turned down [a $1.25 billion acquisition from Yahoo](https://www.youtube.com/watch?v=RwUA5i-QolY), which didn’t share that vision. By sticking to their guns, they were able to attract the content creators they were after and the audience of those creators. Later, they expanded to politics, vlogging, art, education, and (most infamously) [hot tubs](https://blog.twitch.tv/en/2021/05/21/lets-talk-about-hot-tub-streams/).

-
**StackOverflow** started as a question-and-answer forum for any and all programming questions, later expanding to the[Stack Exchange Network.](https://www.reuters.com/article/idUS79274282920110309) Now, you can find question-and-answer forums on everything from [history](https://history.stackexchange.com/) to [tabletop roleplaying](https://rpg.stackexchange.com/) to [grammar](https://english.stackexchange.com/).
...
-
**Amazon** [famously started by selling books online](https://www.businessinsider.com/jeff-bezos-amazon-history-facts-2017-4) and now sells just about everything under the sun. Their true innovation was creating a new way of selling things on the internet, but books were a good place to start because they’re easy to ship,  the buyer doesn’t need to try it on, and the buyer knows they want the exact book they’re looking for. Bezos started with a product he knew he could follow through on and tackled the harder stuff later.
...
-
**Zaarly** is a good example of *not *picking a wedge initially, and backing into one later out of necessity. They launched as a [“reverse craigslist”](https://techcrunch.com/2013/03/09/zaarly-shutters-its-reverse-craigslist-marketplace-goes-all-in-on-virtual-storefronts-as-co-founder-exits/) where anyone could request anything. You can’t deliver every possibility, though. So they later switched to focus [solely on contracting and remodeling work](https://www.zaarly.com/).
...
-
**Clubhouse** focused on “Silicon Valley Twitter,” [providing invites to influential people within that community](https://www.nytimes.com/2020/12/23/style/clubhouse-app-influencers.html) to experience this new concept of “drop-in” audio. Because they gave out a limited amount of invites, you had to know somebody to get into the app. Clubhouse has since gained a global footprint and adoption by many different communities, but it all started with one tiny slice of Twitter.

-
**Discord**, similar to Twitch, focused first on gamers, providing an easy way to voice chat with your friends as you play. From there, it’s become a tool for all types of communities to gather, [including our own](https://every.to/everything/the-sunday-digest-draft-a0c691a4-ed89-420d-922c-c659f035c099).

-
**Facebook** famously [started at Harvard](https://www.theguardian.com/technology/2007/jul/25/media.newmedia) About a month later, they expanded to other schools [like Yale and Stanford](https://web.archive.org/web/20080228004941/http://www.facebook.com/press/info.php?timeline). A year after that, they expanded from college students to high school students, then took off from there.
...
-
**Tesla **started as a very high-end luxury brand with their first model, the Roadster, costing  [$80,000-$120,000](https://www.autoblog.com/2006/07/20/tesla-roadster-unveiled-in-santa-monica/). Starting at this price range limited the number of cars they’d need to produce while proving that electric cars are not only viable, but also drool-worthy. Later, they introduced their Model 3  starting at $35,000 and ended up with a [years-long waitlist](https://www.businessinsider.com/tesla-standard-range-model-3-customers-face-extended-wait-2019-4).

-
**Madewell** was [a workwear brand](https://www.nytimes.com/2019/09/17/business/madewell-ipo-j-crew.html) at first, which you might be able to tell from its name, but in the early 2000s pivoted to e-commerce. They found their jeans were popular among young women, so they went all-in on women’s clothing for a while. Later, they expanded their line to include casual clothing for just about anyone, but they got their fresh start by focusing on one demographic group.

-
**Lululemon** only made high-quality [women’s yoga clothing in the mid-2000s.](https://info.lululemon.com/about/our-story/history) It’s a fairly safe bet that people into yoga are also into things like running and cycling. So, once they built out a fanbase of women who loved their yoga products, they expanded to other hobbies and added men’s and children’s clothing.
...
One famous example of this skepticism is when Jeff Bezos gave a guest lecture to a graduate-level Harvard business class. The students were convinced [stores like Sears and Barnes & Noble were about to eat Amazon’s lunch](https://www.inc.com/chris-matyszczyk/a-harvard-student-told-jeff-bezos-something-no-ceo-wants-to-hear-worse-was-way-he-said-it.html), with one student telling Bezos:
...
Airbnb, for example, spent time with their early hosts in New York and [realized](https://review.firstround.com/How-design-thinking-transformed-Airbnb-from-failing-startup-to-billion-dollar-business) their most successful ones had high-quality photos of their apartments. So they hired photographers to take better photos and saw bookings double. It was much easier to learn and apply this lesson with a smaller base of hosts—whose example later hosts would follow.
One way of thinking about it: it’s easier to [do things that don’t scale](http://paulgraham.com/ds.html) if you’re not prematurely trying to scale.
...
Discord also started with the gaming community and learned a lot about all the complexities involved with running communities as they’ve expanded to professional communities ([like ours](https://every.to/everything/the-sunday-digest-draft-a0c691a4-ed89-420d-922c-c659f035c099)), [classrooms](https://support.discord.com/hc/en-us/articles/360040613072-How-to-Use-Discord-for-Your-Classroom), and [crypto-art projects](https://every.to/divinations/will-daos-replace-corporations), many of the lessons around moderation, automation, and engagement transfer.
...
It helps to recognize this is a really common thing for founders to be anxious about. Talk to a mentor, meditate, read a book about [cognitive behavioral therapy](https://www.amazon.com/dp/B009UW5X4C/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1), which is an incredible tool for seeing reality more clearly. Whatever works!
