---
title: "The Vatican Has Some Thoughts on AI"
subtitle: "In a new statement, the Catholic Church expounds on the nature of human versus machine intelligence, and its views on the utility of AI"
author: "Evan Armstrong"
date: 2025-02-06
column: napkin-math
url: https://every.to/napkin-math/the-vatican-has-some-thoughts-on-ai
paywalled: true
scraped_at: 2026-06-11T16:07:49.477Z
---
...
*Quick heads up: There are only four more days to register for my course, *[How to Write With AI](http://writewithai.xyz/)*. The four-week cohort-based class runs from February 13 through March 6 and includes:*
...
-
***Interviews with successful internet writers****, including Every CEO and cofounder *[Dan Shipper](https://every.to/@danshipper)

-
***Demos of cutting-edge products**** including *[Deep Research](https://every.to/chain-of-thought/we-tried-openai-s-new-deep-research-here-s-what-we-found)*, *[Operator](https://every.to/chain-of-thought/we-tried-openai-s-new-agent-here-s-what-we-found)*, and others*
...
*Over 90 students—including founders, aspiring writers, engineers, and professors—have already taken the course. Check out the *[website](http://writewithai.xyz/)* for more information and to enroll. Act quickly—****registration will close on Sunday night****:*

[Reserve your spot](https://www.writewithai.xyz/)
...
The [Vatican](https://every.to/c/ai-frontiers) released a document last week called ["ANTIQUA ET NOVA: Note on the Relationship Between Artificial Intelligence and Human Intelligence"](https://www.vatican.va/roman_curia/congregations/cfaith/documents/rc_ddf_doc_20250128_antiqua-et-nova_en.html), in which* *they do their best to help resolve some of this dread. It may surprise you, but this isn’t the Catholic Church’s first foray into wrestling with the implications of AI. The Vatican has been working on this since at least 2016, when it hosted a panel at [South by Southwest](https://www.americamagazine.org/politics-society/2025/01/31/vatican-artificial-intelligence-benanti-249821#:~:text=attended%20the%20Web%20Summit%20in,by%20Southwest%20in%20Austin%2C%20Tex), and the pope has met with Meta chief Mark Zuckerberg and a variety of other tech luminaries over the last several years.
