---
title: "How to Price Generative AI Products"
subtitle: "In a marginal cost world, willingness to pay is king"
author: "Ian Clark"
date: 2023-09-18
column: p
url: https://every.to/p/how-to-price-generative-ai-products
paywalled: false
scraped_at: 2026-06-11T16:08:13.519Z
---
...
This essay is brought to you by [The Commons](https://hello.jointhecommons.co/general-every/). Want to invest in your team and retain your top talent? Check out The Commons - a private community of 1000+ tech operators across 400+ companies.

[Learn More](https://hello.jointhecommons.co/general-every/)

[Want to sponsor Every? Click here](https://every.to/cdn-cgi/l/email-protection#7605061918051904051e1f060536130013040f580219).

It seems like a new generative AI startup is calling me every other day with the same question: how should they set their prices?
...
Unlock your team's full potential with [The Commons](https://hello.jointhecommons.co/general-every/) - a premier learning community that gathers 1000+ insightful tech operators from 400+ trailblazing companies.

Did you know 94% of your team would stick with you longer if you invested in their growth? Say goodbye to ineffective training programs and shift to their empowering Sprints, designed to boost your Product, Strategy & operations, Growth, and Strategic Finance teams.

Companies like ResQ, Float, and Thumbtack are already harnessing the power of collective learning and growth with [The Commons](https://hello.jointhecommons.co/general-every/). Now, it's your turn. Their cohorts are curated and highly limited, but you can get priority access here.

[Get Priority Access](https://hello.jointhecommons.co/general-every/)
...
I’ve been talking about measuring customer willingness to pay as if it’s something you can do with a measuring tape. In practice, you need to use one of many “pricing methodologies.” One of my favorite methods is the “[Van Westendorp](https://en.wikipedia.org/wiki/Van_Westendorp%27s_Price_Sensitivity_Meter),” a technique introduced by Dutch economist Peter van Westerndorp in 1976 that helps determine consumer price preferences. Ask customers what a reasonable or bargain price would be for your product, as well as an expensive and prohibitive price. By getting three or four data points per customer (some methods also ask for “too cheap”), you can approximate a demand curve for a whole segment of customers.
...
[Ian Clark](https://www.linkedin.com/in/ian-harrison-clark/)* has over a decade of experience helping software and internet companies monetize their products. His clients include companies such as Y Combinator, LinkedIn, Eventbrite, and Cloudflare. He is the author of a *[book on monetization](https://www.dolphilearning.com/programs/monetization)*. *
