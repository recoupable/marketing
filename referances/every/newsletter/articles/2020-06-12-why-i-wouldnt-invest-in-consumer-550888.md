---
title: "Why I wouldn’t invest in consumer health hardware"
subtitle: "(Ceci n’est pas investment advice.)"
author: "Nathan Baschez"
date: 2020-06-12
column: divinations
url: https://every.to/divinations/why-i-wouldnt-invest-in-consumer-550888
paywalled: false
scraped_at: 2026-06-11T16:09:26.982Z
---
...
Yesterday’s post on [Apple’s health strategy](https://every.to/divinations/healthos-552047) solidified a suspicion I’ve been harboring for awhile, which is that the future is going to be rough for connected health and fitness devices — Peloton, Eight Sleep, Withings, Mirror, WHOOP, etc.
...
How does this happen? The OS will define some sort of standard data format, and the device makers will be forced to conform to that standard if they want to reach end users. For example Apple defines a variety of standard health characteristics (blood type, DOB, “fitzpatrick skin type”), activity types (step count, swimming stroke count, flights climbed), and vital signs (heart rate, oxygen saturation, body temp) in their [health API](https://developer.apple.com/documentation/healthkit/data_types). If you’re creating a device and have a slightly different way of doing things for some reason, well, too bad. Now you’ve got to choose between distribution and optimization.

This is the interesting thing about the “[finding power](https://every.to/divinations/finding-power-432187)” framework. It posits that for every interface between two layers of the value chain, one side must be suboptimized and conformable (in this case, the health devices) in order to allow the other side to be optimized and integrated (in this case, the health OS that I imagine Apple is building).
