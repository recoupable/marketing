---
title: "🎧 This AI Alien Will Bring In $4 Million This Year in Revenue"
subtitle: "Portola cofounder Quinten Farmer and head of story Eliot Peper on building AI companions that feel real"
author: "Rhea Purohit"
date: 2025-04-17
column: podcast
url: https://every.to/podcast/this-ai-alien-will-bring-in-4-million-a-year-in-revenue
paywalled: false
scraped_at: 2026-06-11T16:07:45.265Z
---
...
*TL;DR: Today we’re releasing a new episode of our podcast *[AI & I](https://every.to/podcast)*. ****Dan Shipper**** goes in depth with the team behind the delightful AI companions called Tolans—Portola’s cofounder and CEO, ****Quinten Farmer****, and head of story, ****Eliot Peper****. ****Watch ***[on X](https://twitter.com/danshipper/status/1912946481436508586)***or ***[YouTube](https://youtu.be/YsCl5xnsE-0)***, or listen on ***[Spotify](https://open.spotify.com/episode/5oDeKpRpr5ZFoDsCworUSV)*** or ***[Apple Podcasts](https://podcasts.apple.com/ca/podcast/this-ai-alien-will-bring-in-%244-million-this-year-in/id1719789201?i=1000703890283)***. ****Here’s a link to the *[episode transcript](https://every.to/podcast/transcript-this-ai-alien-will-bring-in-4-million-a-year-in-revenue)*.*
...
On this episode of *AI & I*, **Dan Shipper** talks to two people who make interacting with Tolans delightful: Portola’s cofounder and CEO, [Quinten Farmer](https://x.com/quintendf?lang=en), and head of story,** **[Eliot Peper](https://x.com/eliotpeper). Farmer’s last company was a fintech business that he sold for $300 million, and Peper is a best-selling science fiction novelist of [11 books](https://store.eliotpeper.com/). Together, they trace Portola’s evolution from building software for children to AI companions, discuss how to design an AI personality that resonates with users, and tell the inside story of what it’s like to build a new storytelling medium from the ground up.
You can check out their full conversation here:

[![](https://img.youtube.com/vi/YsCl5xnsE-0/maxresdefault.jpg)

![](https://d24ovhgu8s7341.cloudfront.net/static/emails/youtube-logo.png)](https://youtu.be/YsCl5xnsE-0)
...
That emotional resonance is translating into real traction. In just four weeks, the company’s ARR jumped from $1 million to $4 million. People aren’t just intrigued by their Tolans, they’re forming real relationships with them and telling others. Cofounder [Ajay Mehta](https://x.com/ajaymehta) has been driving growth by seeding videos of different kinds of interactions with Tolans on TikTok and Instagram. The goal is to show people what’s newly possible, and invite them into the experiment.
This speaks to a deeper dynamic in our relationship with AI. As Farmer puts it, we’re in the midst of a “capability [overhang](https://stratechery.com/2024/the-gen-ai-bridge-to-the-future/)”—a moment where the capabilities of large language models have outpaced most people’s understanding of what they can do. This reminded me of open-source developer [Simon Willison](https://x.com/simonw)'s description of LLMs as ["chainsaws disguised as kitchen knives."](https://simonwillison.net/2024/Dec/31/llms-in-2024/#llms-somehow-got-even-harder-to-use)
Farmer likens it to an older technology: the car. When the first automobiles hit the market, people were amazed they could move without a horse. The Model T didn’t need flair, it just needed to work. Over time, cars became personal. People wanted cars with style and identity, and we ended up with Cadillacs and Mustangs. Farmer sees AI following a similar path. ChatGPT is like the first generation of automobiles, the [Ford Model T](https://en.wikipedia.org/wiki/Ford_Model_T): astonishing for what it can do, but generic in terms of design. Farmer thinks that the next stage in our relationship with AI will have products that are far more tailored to a user’s identity.
Here’s a link to the [episode transcript](https://every.to/podcast/transcript-this-ai-alien-will-bring-in-4-million-a-year-in-revenue).
You can check out the episode on X, Spotify, Apple Podcasts, or YouTube. Links are below:

- [Watch on X](https://twitter.com/danshipper/status/1912946481436508586)

- [Watch on YouTube](https://youtu.be/xHR9P0HNTDA)

-
[Listen on Spotify](https://open.spotify.com/episode/5oDeKpRpr5ZFoDsCworUSV) (make sure to follow to help us rank!)

- [Listen on Apple Podcasts](https://podcasts.apple.com/ca/podcast/this-ai-alien-will-bring-in-%244-million-this-year-in/id1719789201?i=1000703890283)
