---
title: "Action Item: Progress Over Process, Remembering What You Read, Zettelkasten"
subtitle: "Read to the end to learn what else you get from your subscription"
author: "Dan Shipper"
date: 2020-10-28
column: superorganizers
url: https://every.to/superorganizers/action-item-progress-over-process-15858850
paywalled: false
scraped_at: 2026-06-11T16:09:14.356Z
---
...
This week we’re covering one of our most popular interviews ever: [How to Build a Learning Machine](https://every.to/superorganizers/how-to-build-a-learning-machine-299655) with [Simon Eskildsen](https://twitter.com/sirupsen).
...
Simon wants to have a [T-shaped personality](https://en.wikipedia.org/wiki/T-shaped_skills)—so he reads widely rather than deeply.
...
**📕 Read: **[How Jeopardy! Champion Roger Craig uses spaced repetition to remember everything](https://every.to/superorganizers/how-a-jeopardy-champion-remembers-294325)

---

#### 🤯 Zettlekasten for big ideas

To keep track of big ideas he custom-built a [Zettlekasten](https://every.to/superorganizers/forget-forgetting-build-a-zettelkasten-299960) system, using Markdown. “If I’m writing a presentation, thinking about a problem, or doing any kind of creative work, my Zettelkasten is a gold-mine,” Simon says.

##### 🔨 USE IT

- Simon keeps his Zettelkasten system as an open source project on GitHub. You can download it yourself [here](https://github.com/sirupsen/zk).

##### 🤓 MY REACTION

- I frequently see people with programming backgrounds like Simon roll their own systems (for example: [Caesar Bautista](https://every.to/superorganizers/why-ceasar-bautista-wrote-his-own-293275)) and **I think there’s a lot of merit in a plain-text second brain that lives on your desktop.**
...
-
**But it’s not very user friendly, and usually mobile input is a pain.** So if you’re non-technical and want a similar experience, I recommend using [Roam](http://roamresearch.com/).

**📕 Read: **[Forget Forgetting. Build a Zettelkasten](https://every.to/superorganizers/forget-forgetting-build-a-zettelkasten-299960).
...
Simon uses a [reMarkable tablet](https://remarkable.com/) to dig into dense PDFs or Google docs that are hard to parse on a Kindle. He finds it a better reading experience for those formats than a laptop, in most cases.
...
For the full story on Simon and how he came to organize his own brain so effectively, (plus, the details on his project to cook a dinner from every country in the world) [read the full article here](https://every.to/superorganizers/how-to-build-a-learning-machine-299655).
...
-
[Dealing with Co-Founder Resentment](https://every.to/askjerry/jerry-colonna-on-co-founder-resentment-10651794), by Jerry Colonna and Andy Sparks

-
[Ask a Journalist](https://every.to/thelongconversation/tlc-3-ask-a-journalist-with-john-15353980), a live event on writing with award winning journalist John H. Richardson, hosted by Rachel Jepsen of The Long Conversation (I’ll be there live too!)

But that’s not all! The Everything bundle now includes 10 newsletters and shows. Find more [here](https://every.to/everything/).
