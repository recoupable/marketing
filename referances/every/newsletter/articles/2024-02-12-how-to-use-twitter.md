...
subtitle: "You can still take advantage of the serendipity of the network"
author: "Nabeel Qureshi"
date: 2024-02-12
column: p
url: https://every.to/p/how-to-use-twitter
paywalled: false
scraped_at: 2026-06-11T16:08:07.676Z
---
...
##### Replying on Twitter is an art, and most people are terrible at it. Practice “[good reply game](https://twitter.com/visakanv/status/1039420186586038273).”
...
- You can combine these two. For example, [here are Andrej Karpathy’s tweets on LLMs](https://twitter.com/search?q=from%3Akarpathy%20llms%20min_faves%3A100&src=typed_query), with a popularity filter included.
...
I owe this idea to Michael Nielsen’s essay [on creative contexts](https://michaelnotebook.com/creative_context/index.html).** **If you get it right, asking questions on Twitter can elicit a staggering variety of interesting answers. Two recent examples: (a) [why don't education startups work out?](https://twitter.com/nabeelqu/status/1673833880002887682) (b) [why don't more people use spaced repetition?](https://twitter.com/nabeelqu/status/1731386142581231898) I don't know how I would have gotten so many interesting answers without Twitter.
...
Post a demo video or a Github link. Talk about the process of building it. There are tons of accounts that do this super well (e.g., [Sharif Shameem](https://twitter.com/sharifshameem), [Linus Lee](https://twitter.com/thesephist)); go copy them. It's a cheat code for the ambitious.
...
For example, I love [Karpathy’s best tweets](https://karpathy.ai/tweets.html), [Michael Nielsen on spaced repetition](https://twitter.com/michael_nielsen/status/957763229454774272), and [Emmett Shear on burnout](https://twitter.com/eshear/status/1561120325584109574). There are too many to list here.

## Build common knowledge

Twitter is of great (and underrated) societal importance. [Patrick McKenzie](https://twitter.com/patio11) [articulates it well](https://conversationswithtyler.com/episodes/patrick-mckenzie/):
...
There is a deeper point here: Twitter is one of the few places in the world you can, if you want, create [common knowledge](https://en.wikipedia.org/wiki/Common_knowledge_(logic)) about important and neglected things. This can make it a powerful lever for action, if you use it correctly.
What a wonderful place! A gem of the internet.

---

*Thanks to *[Tyler Cowen](https://twitter.com/tylercowen)*, *[Rohit Krishnan](https://twitter.com/krishnanrohit)*, and *[Matt Clifford](https://twitter.com/matthewclifford)*—all of whom I met or became closer to via Twitter, and all of whom have great Twitter accounts that you should follow—for reading a draft of this piece.*
[Nabeel S. Qureshi](https://nabeelqu.co/)* is a software engineer and writer currently focused on AI, supported by Emergent Ventures. He is also a visiting scholar with the Program on Artificial Intelligence and Progress at the Mercatus Center. This piece was originally published on his *[website](https://nabeelqu.co/twitter)*.*
