---
title: "The Mind-Bending Magic of Self-Paying Loans - DeFriday #4"
subtitle: "How Alchemix changes the wealth building game"
author: "Nat Eliason"
date: 2021-06-10
column: almanack
url: https://every.to/almanack/alchemix-self-paying-loans
paywalled: false
scraped_at: 2026-06-11T16:08:57.482Z
---
...
Crazy? Kinda. But we’re closer to this world than you think. Enter [Alchemix](https://app.alchemix.fi/): a new kind of DeFi protocol that allows anyone to borrow against the future yield of their assets.
...
[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1729/optimized_dKOmFwU-4cs2kLmunHPT-yN4jOHqdemUKIhGM7BUC1YIia0-HSiNLFR6imBDmAgku6gWgy30eAcnDwbpBaWZ9JAst4lHwrmgI3lHh86EX7K9OlL8IOEuLA8Um9Rl31crSE5i1mQ-.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1729/optimized_dKOmFwU-4cs2kLmunHPT-yN4jOHqdemUKIhGM7BUC1YIia0-HSiNLFR6imBDmAgku6gWgy30eAcnDwbpBaWZ9JAst4lHwrmgI3lHh86EX7K9OlL8IOEuLA8Um9Rl31crSE5i1mQ-.png?link=true)
...
We’ll use these parameters from [Nerdwallet](https://www.nerdwallet.com/article/loans/auto-loans/car-loan-calculator):

[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1729/optimized_4ThVmW2wD6t3sK8g3LK_6Gy6Sdzqgnn4vdZyTT4dkXiBl6tzYXQkUsza1v7F1NUn_zSIZ98Lj10hHphT_JRDSJKeHK7EmzRKu11D-zCBSw_yuM_OGjGlM5CozcrYscgITKNiXS4A.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1729/optimized_4ThVmW2wD6t3sK8g3LK_6Gy6Sdzqgnn4vdZyTT4dkXiBl6tzYXQkUsza1v7F1NUn_zSIZ98Lj10hHphT_JRDSJKeHK7EmzRKu11D-zCBSw_yuM_OGjGlM5CozcrYscgITKNiXS4A.png?link=true)
...
You peruse [NomadList](https://nomadlist.com/) and discover you can live comfortably in Chiang Mai, Thailand for $1,046 a month, less than the $1,250 you can safely withdraw, so now your savings are completely covering your new highly Instagrammable life.
...
You go deep down the [Mr. Money Mustache](https://www.mrmoneymustache.com/) rabbithole and decide you want to pursue “FIRE” Financial Independence, Retire Early.
...
That said, Alchemix [has been audited](https://alchemixfi.medium.com/certik-audit-passed-with-levitating-colours-1705ff1b2d5d), and they’re also implementing a “[continuous auditing](https://alchemixfi.medium.com/bullish-alchemix-contracts-are-now-under-continuous-audit-with-runtime-verification-fd3b63c33b41)” system for their V2 launch later this year. They’re clearly prioritizing security and covering their bases as much as possible, but as always with DeFi, it’s a new and experimental world and anything could happen.

## Using Alchemix

Using Alchemix is simple enough. If you buy some DAI on Coinbase or another exchange, you can transfer it into your MetaMask wallet, then deposit that DAI into Alchemix [on the Vault page](https://app.alchemix.fi/vault). As soon as it’s deposited, you’ll start earning interest, and be able to borrow against it.
...
[![](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1729/optimized_IpM4FjTj-eLbBp6IF4wH8wL4c-qfiUkPKDujY6stInJbPJWS3Lw1fwYJvx3R4Jo7UIVL8OOJFV57_Ll1KuojSScCYP7o6o_P7VDXigj1leSLca5MSQ9LRV_hog2GSpxY2_SIn4_Y.png)](https://d24ovhgu8s7341.cloudfront.net/uploads/editor/posts/1729/optimized_IpM4FjTj-eLbBp6IF4wH8wL4c-qfiUkPKDujY6stInJbPJWS3Lw1fwYJvx3R4Jo7UIVL8OOJFV57_Ll1KuojSScCYP7o6o_P7VDXigj1leSLca5MSQ9LRV_hog2GSpxY2_SIn4_Y.png?link=true)

## Other News in the World of DeFi

### El Salvador

El Salvador passed a bill to make Bitcoin legal tender in their country, the first country to do so. The [text of the bill is remarkable](https://twitter.com/nayibbukele/status/1402446890466217985/photo/2) and a massive move forward for Bitcoin legal adoption, since it includes provision like:
...
Also remarkable is that while US politicians were complaining about the environmental impact of Bitcoin, El Salvador [dug a well into a volcano](https://twitter.com/nayibbukele/status/1403160745228050433?s=20) to build a 100% renewable energy powered Bitcoin mining operation. It’s also possible that with this new bill, the [US tax code will have to adapt](https://twitter.com/Andrea_Tosato/status/1401283436355239941?s=20) since Bitcoin will be a foreign currency.

### Curve V2

[Curve](https://curve.fi/) is working on launching V2 of their token exchange protocol, and [their new white paper](https://curve.fi/alusd/) is a doozy to try to get through. Curve is also experimenting with its first swap pool for more volatile crypto assets, with a [three-way pool](https://twitter.com/CurveFinance/status/1402673150425509890?s=20) combining Ethereum, Bitcoin, and Tether.

### Zapper

The popular DeFi management tool [Zapper](https://zapper.fi/) has launched a rewards program where you earn experience and level up in the application, and can claim special NFTs at certain levels. Since Zapper doesn’t have a token of their own, it’s possible this is an early way for them to start rewarding users and build a list of addresses for a future token airdrop [similar to what Uniswap did](https://www.coindesk.com/uniswap-dharma-retroactive-uni-airdrop-defi-governance).
