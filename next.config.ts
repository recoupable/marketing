...
export const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: "/build/start",
        destination: "/start-project?workflow=Custom%20systems",
        permanent: true,
      },
      {
        source: "/advisory/book",
        destination: "/contact?workflow=AI%20strategy",
        permanent: true,
      },
    ];
  },
    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "X-Frame-Options", value: "DENY" },
          {
            key: "Link",
            value:
              '</.well-known/api-catalog>; rel="api-catalog", </.well-known/ard.json>; rel="ard", </openapi.json>; rel="service-desc"; type="application/json", </sitemap.xml>; rel="sitemap", </agents.md>; rel="describedby"; type="text/markdown"',
          },
