...
export default function Page() {
 return <div className="sky-subpage sky-usecase">
  <ServiceStructuredData path="/acquisitions" name="AI for music catalog acquisitions" description="Custom AI systems that organize deal materials, prepare a diligence draft, and keep each open question connected to its source." serviceType={["Music catalog acquisition review", "Deal preparation"]} />
      <PageHero eyebrow="CATALOG ACQUISITIONS" title="Put the deal in order." description="Custom AI systems that organize deal materials, prepare a diligence draft, and keep each open question connected to its source."><PageButton href="/acquisitions/contact">Discuss your workflow</PageButton><PageButton secondary href="#workflow">See how it works</PageButton></PageHero>
