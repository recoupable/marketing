 ...
 * left column. Heading utilities carry `!` because globals.css sets unlayered h1/h2/h3 type rules.
 */
export default function PodcastPage() {
  const episodes = readEpisodes();
  return (
    <div className="sky-subpage grid grid-cols-[384px_minmax(0,1fr)] items-start gap-[50px] max-w-[1248px] mx-auto mt-11 px-9 max-[1050px]:grid-cols-[320px_minmax(0,1fr)] max-[1050px]:gap-8 max-[1050px]:px-5 max-[760px]:flex max-[760px]:flex-col max-[760px]:gap-0 max-[760px]:mt-6 max-[760px]:px-0">
