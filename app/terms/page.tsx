...
export const metadata: Metadata = withPageMetadata({ title: "Terms of Use", description: "The terms and conditions that apply to Recoup services, content, APIs, and tools.", alternates: { canonical: "/terms" } });

const sections = [
  { id: '1-use-of-the-service', title: '1. Use of the Service' },
  { id: '2-registration', title: '2. Registration' },
  { id: '3-responsibility-for-content', title: '3. Responsibility for Content' },
  { id: '4-ownership', title: '4. Ownership' },
  { id: '5-user-conduct', title: '5. User Conduct' },
  { id: '6-monitoring', title: '6. Monitoring' },
  { id: '7-third-party-services', title: '7. Third-Party Services' },
  { id: '8-purchase-terms', title: '8. Purchase Terms' },
  { id: '9-subscriptions', title: '9. Subscriptions' },
  { id: '10-indemnification', title: '10. Indemnification' },
  { id: '11-disclaimer-of-warranties', title: '11. Disclaimer of Warranties' },
  { id: '12-limitation-of-liability', title: '12. Limitation of Liability' },
  { id: '13-arbitration-agreement', title: '13. Arbitration Agreement' },
  { id: '14-general-provisions', title: '14. General Provisions' },
  { id: 'contact', title: 'Contact' }
];

export default function TermsPage() {
  return <LegalDocument title="Terms of Use" sections={sections}>
        ...
        <h2 id="3-responsibility-for-content">3. Responsibility for Content</h2>
        <p>
        ...
        <h2 id="8-purchase-terms">8. Purchase Terms</h2>
        <p>
        ...
        <h2 id="9-subscriptions">9. Subscriptions</h2>
        <p>
        ...
        <h2 id="13-arbitration-agreement">13. Arbitration Agreement</h2>
        <p>
