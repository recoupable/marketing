...
export const metadata: Metadata = withPageMetadata({
  title: "Pricing: Recoup Cloud, advisory, and custom builds",
  description: `Recoup Cloud from ${formatUsd(pricingPlans[0].monthlyCents)}/month, Advisory from ${formatUsd(pricingPlans[1].monthlyCents)}/month, and Build + Partner from ${formatUsd(pricingPlans[2].monthlyCents)}/month. Save at least 20% with annual billing.`,
  ...
  return <MarketingPage>
    <div className="pricing-page">
      ...
      <section className="rp-questions" aria-labelledby="pricing-questions">
        ...
        <MarketingFAQ items={[
          { question: "How does annual billing work?", answer: "Annual plans are paid once per year. We apply a 20% discount and round the monthly equivalent down to a whole dollar. The cards show the monthly equivalent and the full annual charge. The discount applies to Recoup Cloud, Advisory, and Build + Partner. Enterprise is quoted separately; API and MCP usage is not included in the discount." },
          ...
          { question: "What’s included in the music skill pack?", answer: "Music-business playbooks for research, content, release planning, and recurring work. The Recoup Cloud plan brings the hosted workspace and skills together. Recoup’s public Skills collection remains open source; tools and services used by a skill may have their own usage charges." },
