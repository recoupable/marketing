# RECOUPABLE — BRAND POSITIONING + WEBSITE STRUCTURE REPORT

> Source of truth for positioning, hero strategy, landing structure, and nav. Reference this when writing copy or changing the site.
...
**Current state:**
- Messaging is fragmented (record label, manager, services, AI agents)
- Product is deep, but presentation feels like a chatbot tool
- Trying to serve: Artists (B2C), Labels / distributors / catalog companies (B2B), Developers / AI systems (infra layer)

**Result:** No clear category ownership; feels smaller than what we're building; doesn't signal "leader" or "infrastructure layer."

---

## 2. Correct Positioning Layer (Non-Negotiable)

**We are not:** a chatbot, a tool, a "feature bundle."
...
**Avoid:** "Operating System," "Backbone," "Platform" (alone).

**Use instead:** Autonomous Music Business, Music Operations, Agents running music workflows.

**Working category:**
- **Internal:** "Autonomous Music Infrastructure"
- **External:** "Run your music business with agents"

---

## 4. Hero Strategy

**Decision:** Path C (Execution) + Path A (Pain as reinforcement).
...
**Top nav:** Platform | Solutions | Developers | Learn | Company

- **Platform (dropdown):** Agents, Workflows, Integrations, Data Layer, API & CLI
...
**Infrastructure layer:** API, agent framework ("harness"), data layer — expose for developers.

**Rule:** Do not present Slack, Web app, or Email as separate products.

---

## 8. Language Strategy (Human + AI)

**Human layer:** Simple, outcome-driven, concrete. Example: "Run your music business with agents."

**AI / SEO layer:** Embed terms across pages — AI agents for music, music automation, music operations, catalog management automation, release automation, fan data analysis.

**Internal vs external:** Internal = "agent harness," "infra layer." External = "agents that run your music business."
